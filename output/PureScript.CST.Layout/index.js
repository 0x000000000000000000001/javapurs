        ...
        return function (stack) {
            ...
            var insertStart = function (lyt) {
                return function (v1) {
                    ...
                    return Data_Function.applyFlipped(Data_Function.applyFlipped(v1)(pushStack(nextPos)(lyt)))(insertToken(lytToken(nextPos)(new PureScript_CST_Types.TokLayoutStart(nextPos.column))));
                };
            };
            ...
            var insertSep = function (v1) {
                ...
                if (v1.value0 instanceof Data_List_Types.Cons && (v1.value0.value0.value1 instanceof LytTopDecl && sepP(v1.value0.value0.value0))) {
                    return Data_Function.applyFlipped(new Data_Tuple.Tuple(v1.value0.value1, v1.value1))(insertToken(sepTok));
                };
                ...
                if (v1.value0 instanceof Data_List_Types.Cons && indentSepP(v1.value0.value0.value0)(v1.value0.value0.value1)) {
                    if (v1.value0.value0.value1 instanceof LytOf) {
                        return Data_Function.applyFlipped(Data_Function.applyFlipped(v1)(insertToken(sepTok)))(pushStack(v.range.start)(LytCaseBinders.value));
                    };
                    return Data_Function.applyFlipped(v1)(insertToken(sepTok));
                };
                return v1;
            };
            ...
            var insertDefault = function (state) {
                return Data_Function.applyFlipped(Data_Function.applyFlipped(Data_Function.applyFlipped(state)(collapse(offsideP)))(insertSep))(insertToken(v));
            };
            var insertKwProperty = function (k) {
                return function (state) {
                    var v1 = Data_Function.applyFlipped(state)(insertDefault);
            ...
            var insert = function (v1) {
                if (v.value instanceof PureScript_CST_Types.TokLowerName && (v.value.value0 instanceof Data_Maybe.Nothing && v.value.value1 === "data")) {
                    var v2 = Data_Function.applyFlipped(v1)(insertDefault);
                    if (isTopDecl(v.range.start)(v2.value0)) {
                        return Data_Function.applyFlipped(v2)(pushStack(v.range.start)(LytTopDecl.value));
                    };
                    return Data_Function.applyFlipped(v2)(popStack(function (v3) {
                ...
                if (v.value instanceof PureScript_CST_Types.TokLowerName && (v.value.value0 instanceof Data_Maybe.Nothing && v.value.value1 === "class")) {
                    var v2 = Data_Function.applyFlipped(v1)(insertDefault);
                    if (isTopDecl(v.range.start)(v2.value0)) {
                        return Data_Function.applyFlipped(v2)(pushStack(v.range.start)(LytTopDeclHead.value));
                    };
                    return Data_Function.applyFlipped(v2)(popStack(function (v3) {
                        return Data_Eq.eq(eqLayoutDelim)(v3)(LytProperty.value);
                    }));
                ...
                if (v.value instanceof PureScript_CST_Types.TokLowerName && (v.value.value0 instanceof Data_Maybe.Nothing && v.value.value1 === "where")) {
                    ...
                    if (v1.value0 instanceof Data_List_Types.Cons && v1.value0.value0.value1 instanceof LytTopDeclHead) {
                        return Data_Function.applyFlipped(Data_Function.applyFlipped(new Data_Tuple.Tuple(v1.value0.value1, v1.value1))(insertToken(v)))(insertStart(LytWhere.value));
                    };
                    if (v1.value0 instanceof Data_List_Types.Cons && v1.value0.value0.value1 instanceof LytProperty) {
                        return Data_Function.applyFlipped(new Data_Tuple.Tuple(v1.value0.value1, v1.value1))(insertToken(v));
                    };
                    return Data_Function.applyFlipped(Data_Function.applyFlipped(Data_Function.applyFlipped(v1)(collapse(whereP)))(insertToken(v)))(insertStart(LytWhere.value));
                };
                if (v.value instanceof PureScript_CST_Types.TokLowerName && (v.value.value0 instanceof Data_Maybe.Nothing && v.value.value1 === "in")) {
                    ...
                    if (v2.value0 instanceof Data_List_Types.Cons && (v2.value0.value0.value1 instanceof LytLetStmt && (v2.value0.value1 instanceof Data_List_Types.Cons && v2.value0.value1.value0.value1 instanceof LytAdo))) {
                        return Data_Function.applyFlipped(Data_Function.applyFlipped(Data_Function.applyFlipped(new Data_Tuple.Tuple(v2.value0.value1.value1, v2.value1))(insertEnd(v2.value0.value0.value0.column)))(insertEnd(v2.value0.value1.value0.value0.column)))(insertToken(v));
                    };
                    if (v2.value0 instanceof Data_List_Types.Cons && isIndented(v2.value0.value0.value1)) {
                        return Data_Function.applyFlipped(Data_Function.applyFlipped(new Data_Tuple.Tuple(v2.value0.value1, v2.value1))(insertEnd(v2.value0.value0.value0.column)))(insertToken(v));
                    };
                    return Data_Function.applyFlipped(Data_Function.applyFlipped(v1)(insertDefault))(popStack(function (v3) {
                        return Data_Eq.eq(eqLayoutDelim)(v3)(LytProperty.value);
                    }));
                };
                if (v.value instanceof PureScript_CST_Types.TokLowerName && (v.value.value0 instanceof Data_Maybe.Nothing && v.value.value1 === "let")) {
                    var next = function (v2) {
                        if (v2.value0 instanceof Data_List_Types.Cons && (v2.value0.value0.value1 instanceof LytDo && v2.value0.value0.value0.column === v.range.start.column)) {
                            return Data_Function.applyFlipped(v2)(insertStart(LytLetStmt.value));
                        };
                        ...
                        return Data_Function.applyFlipped(v2)(insertStart(LytLet.value));
                    };
                    return Data_Function.applyFlipped(v1)(insertKwProperty(next));
                };
                if (v.value instanceof PureScript_CST_Types.TokLowerName && v.value.value1 === "do") {
                    return Data_Function.applyFlipped(v1)(insertKwProperty(insertStart(LytDo.value)));
                };
                if (v.value instanceof PureScript_CST_Types.TokLowerName && v.value.value1 === "ado") {
                    return Data_Function.applyFlipped(v1)(insertKwProperty(insertStart(LytAdo.value)));
                };
                if (v.value instanceof PureScript_CST_Types.TokLowerName && (v.value.value0 instanceof Data_Maybe.Nothing && v.value.value1 === "case")) {
                    return Data_Function.applyFlipped(v1)(insertKwProperty(pushStack(v.range.start)(LytCase.value)));
                };
                if (v.value instanceof PureScript_CST_Types.TokLowerName && (v.value.value0 instanceof Data_Maybe.Nothing && v.value.value1 === "of")) {
                    ...
                    if (v2.value0 instanceof Data_List_Types.Cons && v2.value0.value0.value1 instanceof LytCase) {
                        return Data_Function.applyFlipped(Data_Function.applyFlipped(Data_Function.applyFlipped(new Data_Tuple.Tuple(v2.value0.value1, v2.value1))(insertToken(v)))(insertStart(LytOf.value)))(pushStack(nextPos)(LytCaseBinders.value));
                    };
                    return Data_Function.applyFlipped(Data_Function.applyFlipped(v2)(insertDefault))(popStack(function (v3) {
                        return Data_Eq.eq(eqLayoutDelim)(v3)(LytProperty.value);
                    }));
                };
                if (v.value instanceof PureScript_CST_Types.TokLowerName && (v.value.value0 instanceof Data_Maybe.Nothing && v.value.value1 === "if")) {
                    return Data_Function.applyFlipped(v1)(insertKwProperty(pushStack(v.range.start)(LytIf.value)));
                };
                if (v.value instanceof PureScript_CST_Types.TokLowerName && (v.value.value0 instanceof Data_Maybe.Nothing && v.value.value1 === "then")) {
                    var v2 = Data_Function.applyFlipped(v1)(collapse(indentedP));
                    if (v2.value0 instanceof Data_List_Types.Cons && v2.value0.value0.value1 instanceof LytIf) {
                        return Data_Function.applyFlipped(Data_Function.applyFlipped(new Data_Tuple.Tuple(v2.value0.value1, v2.value1))(insertToken(v)))(pushStack(v.range.start)(LytThen.value));
                    };
                    return Data_Function.applyFlipped(Data_Function.applyFlipped(v1)(insertDefault))(popStack(function (v3) {
                        return Data_Eq.eq(eqLayoutDelim)(v3)(LytProperty.value);
                    }));
                ...
                if (v.value instanceof PureScript_CST_Types.TokLowerName && (v.value.value0 instanceof Data_Maybe.Nothing && v.value.value1 === "else")) {
                    ...
                    if (v2.value0 instanceof Data_List_Types.Cons && v2.value0.value0.value1 instanceof LytThen) {
                        return Data_Function.applyFlipped(new Data_Tuple.Tuple(v2.value0.value1, v2.value1))(insertToken(v));
                    };
                    var v3 = Data_Function.applyFlipped(v1)(collapse(offsideP));
                    if (isTopDecl(v.range.start)(v3.value0)) {
                        return Data_Function.applyFlipped(v3)(insertToken(v));
                    };
                    return Data_Function.applyFlipped(Data_Function.applyFlipped(Data_Function.applyFlipped(v3)(insertSep))(insertToken(v)))(popStack(function (v4) {
                        return Data_Eq.eq(eqLayoutDelim)(v4)(LytProperty.value);
                    }));
                };
                if (v.value instanceof PureScript_CST_Types.TokForall) {
                    return Data_Function.applyFlipped(v1)(insertKwProperty(pushStack(v.range.start)(LytForall.value)));
                };
                if (v.value instanceof PureScript_CST_Types.TokBackslash) {
                    return Data_Function.applyFlipped(Data_Function.applyFlipped(v1)(insertDefault))(pushStack(v.range.start)(LytLambdaBinders.value));
                };
                if (v.value instanceof PureScript_CST_Types.TokRightArrow) {
                    ...
                    return Data_Function.applyFlipped(Data_Function.applyFlipped(Data_Function.applyFlipped(v1)(collapse(arrowP)))(popStack(guardP)))(insertToken(v));
                };
                if (v.value instanceof PureScript_CST_Types.TokEquals) {
                    ...
                    var v2 = Data_Function.applyFlipped(v1)(collapse(equalsP));
                    if (v2.value0 instanceof Data_List_Types.Cons && v2.value0.value0.value1 instanceof LytDeclGuard) {
                        return Data_Function.applyFlipped(new Data_Tuple.Tuple(v2.value0.value1, v2.value1))(insertToken(v));
                    };
                    return Data_Function.applyFlipped(v1)(insertDefault);
                };
                if (v.value instanceof PureScript_CST_Types.TokPipe) {
                    ...
                    if (v2.value0 instanceof Data_List_Types.Cons && v2.value0.value0.value1 instanceof LytOf) {
                        return Data_Function.applyFlipped(Data_Function.applyFlipped(v2)(pushStack(v.range.start)(LytCaseGuard.value)))(insertToken(v));
                    };
                    if (v2.value0 instanceof Data_List_Types.Cons && v2.value0.value0.value1 instanceof LytLet) {
                        return Data_Function.applyFlipped(Data_Function.applyFlipped(v2)(pushStack(v.range.start)(LytDeclGuard.value)))(insertToken(v));
                    };
                ...
                if (v.value instanceof PureScript_CST_Types.TokTick) {
                    ...
                    return Data_Function.applyFlipped(Data_Function.applyFlipped(Data_Function.applyFlipped(Data_Function.applyFlipped(v1)(collapse(offsideEndP)))(insertSep))(insertToken(v)))(pushStack(v.range.start)(LytTick.value));
                };
                if (v.value instanceof PureScript_CST_Types.TokComma) {
                    ...
                    if (v2.value0 instanceof Data_List_Types.Cons && v2.value0.value0.value1 instanceof LytBrace) {
                        return Data_Function.applyFlipped(Data_Function.applyFlipped(v2)(insertToken(v)))(pushStack(v.range.start)(LytProperty.value));
                    };
                    return Data_Function.applyFlipped(v2)(insertToken(v));
                };
                if (v.value instanceof PureScript_CST_Types.TokDot) {
                    ...
                    return Data_Function.applyFlipped(v2)(pushStack(v.range.start)(LytProperty.value));
                };
                if (v.value instanceof PureScript_CST_Types.TokLeftParen) {
                    return Data_Function.applyFlipped(Data_Function.applyFlipped(v1)(insertDefault))(pushStack(v.range.start)(LytParen.value));
                };
                if (v.value instanceof PureScript_CST_Types.TokLeftBrace) {
                    return Data_Function.applyFlipped(Data_Function.applyFlipped(Data_Function.applyFlipped(v1)(insertDefault))(pushStack(v.range.start)(LytBrace.value)))(pushStack(v.range.start)(LytProperty.value));
                };
                if (v.value instanceof PureScript_CST_Types.TokLeftSquare) {
                    return Data_Function.applyFlipped(Data_Function.applyFlipped(v1)(insertDefault))(pushStack(v.range.start)(LytSquare.value));
                };
                if (v.value instanceof PureScript_CST_Types.TokRightParen) {
                    return Data_Function.applyFlipped(Data_Function.applyFlipped(Data_Function.applyFlipped(v1)(collapse(indentedP)))(popStack(function (v2) {
                        return Data_Eq.eq(eqLayoutDelim)(v2)(LytParen.value);
                    })))(insertToken(v));
                };
                if (v.value instanceof PureScript_CST_Types.TokRightBrace) {
                    return Data_Function.applyFlipped(Data_Function.applyFlipped(Data_Function.applyFlipped(Data_Function.applyFlipped(v1)(collapse(indentedP)))(popStack(function (v2) {
                ...
                if (v.value instanceof PureScript_CST_Types.TokString) {
                    return Data_Function.applyFlipped(Data_Function.applyFlipped(v1)(insertDefault))(popStack(function (v2) {
                        return Data_Eq.eq(eqLayoutDelim)(v2)(LytProperty.value);
                    }));
                };
                ...
                if (v.value instanceof PureScript_CST_Types.TokOperator) {
                    return Data_Function.applyFlipped(Data_Function.applyFlipped(Data_Function.applyFlipped(v1)(collapse(offsideEndP)))(insertSep))(insertToken(v));
                };
                return Data_Function.applyFlipped(v1)(insertDefault);
            };
