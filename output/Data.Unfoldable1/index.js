            ...
            return function (s) {
                var go = function (v) {
                    return new Data_Tuple.Tuple(v.value0, (function () {
                        var $13 = v.value1 > 0;
                        if ($13) {
                            return Data_Function.apply(Data_Maybe.Just.create)(Data_Function.apply(Data_Tuple.Tuple.create(f(v.value0)))(v.value1 - 1 | 0));
                        };
                        return Data_Maybe.Nothing.value;
                    })());
                };
                return Data_Function.apply(unfoldr1(dictUnfoldable1)(go))(new Data_Tuple.Tuple(s, n - 1 | 0));
            };
        };
    };
};
