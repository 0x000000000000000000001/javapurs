...
var ExprTypeApp = /* #__PURE__ */ (function () {
    function ExprTypeApp(value0, value1, value2) {
        this.value0 = value0;
        this.value1 = value1;
        this.value2 = value2;
    };
    ExprTypeApp.create = function (value0) {
        return function (value1) {
            return function (value2) {
                return new ExprTypeApp(value0, value1, value2);
            };
        };
    };
    return ExprTypeApp;
...
var $lazy_functorBinder = /* #__PURE__ */ $runtime_lazy("functorBinder", "PureScript.Backend.Optimizer.CoreFn", function () {
    return {
        map: function (f) {
            return function (m) {
                ...
                if (m instanceof BinderNamed) {
                    return new BinderNamed(f(m.value0), m.value1, Data_Functor.map($lazy_functorBinder(0))(f)(m.value2));
                };
                if (m instanceof BinderLit) {
                    return new BinderLit(f(m.value0), Data_Functor.map(functorLiteral)(Data_Functor.map($lazy_functorBinder(0))(f))(m.value1));
                };
                if (m instanceof BinderConstructor) {
                    return new BinderConstructor(f(m.value0), m.value1, m.value2, Data_Functor.map(Data_Functor.functorArray)(Data_Functor.map($lazy_functorBinder(0))(f))(m.value3));
                };
                throw new Error("Failed pattern match at PureScript.Backend.Optimizer.CoreFn (line 0, column 0 - line 0, column 0): " + [ m.constructor.name ]);
            };
        }
        ...
        map: function (f) {
            return function (m) {
                if (m instanceof NonRec) {
                    return new NonRec(Data_Functor.map($lazy_functorBinding(0))(f)(m.value0));
                };
                if (m instanceof Rec) {
                    return new Rec(Data_Functor.map(Data_Functor.functorArray)(Data_Functor.map($lazy_functorBinding(0))(f))(m.value0));
                };
                throw new Error("Failed pattern match at PureScript.Backend.Optimizer.CoreFn (line 0, column 0 - line 0, column 0): " + [ m.constructor.name ]);
            };
        }
...
var $lazy_functorBinding = /* #__PURE__ */ $runtime_lazy("functorBinding", "PureScript.Backend.Optimizer.CoreFn", function () {
    return {
        map: function (f) {
            return function (m) {
                return new Binding(f(m.value0), m.value1, Data_Functor.map($lazy_functorExpr(0))(f)(m.value2));
            };
        }
    };
});
var $lazy_functorCaseAlternative = /* #__PURE__ */ $runtime_lazy("functorCaseAlternative", "PureScript.Backend.Optimizer.CoreFn", function () {
    return {
        map: function (f) {
            return function (m) {
                return new CaseAlternative(Data_Functor.map(Data_Functor.functorArray)(Data_Functor.map(functorBinder)(f))(m.value0), Data_Functor.map($lazy_functorCaseGuard(0))(f)(m.value1));
            };
        }
    };
});
var $lazy_functorCaseGuard = /* #__PURE__ */ $runtime_lazy("functorCaseGuard", "PureScript.Backend.Optimizer.CoreFn", function () {
    return {
        map: function (f) {
            return function (m) {
                if (m instanceof Unconditional) {
                    return new Unconditional(Data_Functor.map($lazy_functorExpr(0))(f)(m.value0));
                };
                if (m instanceof Guarded) {
                    return new Guarded(Data_Functor.map(Data_Functor.functorArray)(Data_Functor.map($lazy_functorGuard(0))(f))(m.value0));
                };
                throw new Error("Failed pattern match at PureScript.Backend.Optimizer.CoreFn (line 0, column 0 - line 0, column 0): " + [ m.constructor.name ]);
            };
        }
...
var $lazy_functorExpr = /* #__PURE__ */ $runtime_lazy("functorExpr", "PureScript.Backend.Optimizer.CoreFn", function () {
    return {
        map: function (f) {
            return function (m) {
                ...
                if (m instanceof ExprLit) {
                    return new ExprLit(f(m.value0), Data_Functor.map(functorLiteral)(Data_Functor.map($lazy_functorExpr(0))(f))(m.value1));
                };
                ...
                if (m instanceof ExprAccessor) {
                    return new ExprAccessor(f(m.value0), Data_Functor.map($lazy_functorExpr(0))(f)(m.value1), m.value2);
                };
                if (m instanceof ExprUpdate) {
                    return new ExprUpdate(f(m.value0), Data_Functor.map($lazy_functorExpr(0))(f)(m.value1), Data_Functor.map(Data_Functor.functorArray)(Data_Functor.map(functorProp)(Data_Functor.map($lazy_functorExpr(0))(f)))(m.value2));
                };
                if (m instanceof ExprAbs) {
                    return new ExprAbs(f(m.value0), m.value1, Data_Functor.map($lazy_functorExpr(0))(f)(m.value2));
                };
                if (m instanceof ExprApp) {
                    return new ExprApp(f(m.value0), Data_Functor.map($lazy_functorExpr(0))(f)(m.value1), Data_Functor.map($lazy_functorExpr(0))(f)(m.value2));
                };
                if (m instanceof ExprCase) {
                    return new ExprCase(f(m.value0), Data_Functor.map(Data_Functor.functorArray)(Data_Functor.map($lazy_functorExpr(0))(f))(m.value1), Data_Functor.map(Data_Functor.functorArray)(Data_Functor.map($lazy_functorCaseAlternative(0))(f))(m.value2));
                };
                if (m instanceof ExprLet) {
                    return new ExprLet(f(m.value0), Data_Functor.map(Data_Functor.functorArray)(Data_Functor.map($lazy_functorBind(0))(f))(m.value1), Data_Functor.map($lazy_functorExpr(0))(f)(m.value2));
                };
                if (m instanceof ExprTypeApp) {
                    return new ExprTypeApp(f(m.value0), Data_Functor.map($lazy_functorExpr(0))(f)(m.value1), m.value2);
                };
                throw new Error("Failed pattern match at PureScript.Backend.Optimizer.CoreFn (line 0, column 0 - line 0, column 0): " + [ m.constructor.name ]);
            };
        }
...
var $lazy_functorGuard = /* #__PURE__ */ $runtime_lazy("functorGuard", "PureScript.Backend.Optimizer.CoreFn", function () {
    return {
        map: function (f) {
            return function (m) {
                return new Guard(Data_Functor.map($lazy_functorExpr(0))(f)(m.value0), Data_Functor.map($lazy_functorExpr(0))(f)(m.value1));
            };
        }
    };
});
...
var $lazy_foldableLiteral = /* #__PURE__ */ $runtime_lazy("foldableLiteral", "PureScript.Backend.Optimizer.CoreFn", function () {
    return {
        foldl: function (k) {
            return Data_Foldable.foldlDefault($lazy_foldableLiteral(0))(k);
        },
        foldr: function (k) {
            return Data_Foldable.foldrDefault($lazy_foldableLiteral(0))(k);
        },
        foldMap: function (dictMonoid) {
...
var $lazy_traversableLiteral = /* #__PURE__ */ $runtime_lazy("traversableLiteral", "PureScript.Backend.Optimizer.CoreFn", function () {
    return {
        ...
        sequence: function (dictApplicative) {
            return function (a) {
                return Data_Traversable.sequenceDefault($lazy_traversableLiteral(0))(dictApplicative)(a);
            };
        },
        Functor0: function () {
...
var $lazy_eqExprType = /* #__PURE__ */ $runtime_lazy("eqExprType", "PureScript.Backend.Optimizer.CoreFn", function () {
    return {
        eq: function (x) {
            return function (y) {
                ...
                if (x instanceof $$Array && y instanceof $$Array) {
                    return Data_Eq.eq($lazy_eqExprType(0))(x.value0)(y.value0);
                };
                if (x instanceof TypeVar && y instanceof TypeVar) {
                    return x.value0 === y.value0;
                };
                if (x instanceof ADT && y instanceof ADT) {
                    return x.value0 === y.value0 && Data_Eq.eq(eqArray)(x.value1)(y.value1) && Data_Eq.eq(Data_Eq.eqArray($lazy_eqExprType(0)))(x.value2)(y.value2);
                };
                if (x instanceof TypeApp && y instanceof TypeApp) {
                    return Data_Eq.eq($lazy_eqExprType(0))(x.value0)(y.value0) && Data_Eq.eq(Data_Eq.eqArray($lazy_eqExprType(0)))(x.value1)(y.value1);
                };
                if (x instanceof Func && y instanceof Func) {
                    return Data_Eq.eq(Data_Eq.eqArray($lazy_eqExprType(0)))(x.value0)(y.value0) && Data_Eq.eq($lazy_eqExprType(0))(x.value1)(y.value1);
                };
                if (x instanceof Row && y instanceof Row) {
                    return Data_Eq.eq(Data_Eq.eqArray(eqTuple($lazy_eqExprType(0))))(x.value0)(y.value0) && Data_Eq.eq(Data_Maybe.eqMaybe($lazy_eqExprType(0)))(x.value1)(y.value1);
                };
                if (x instanceof Record && y instanceof Record) {
                    return Data_Eq.eq($lazy_eqExprType(0))(x.value0)(y.value0);
                };
                if (x instanceof ForAll && y instanceof ForAll) {
                    return Data_Eq.eq(eqArray)(x.value0)(y.value0) && Data_Eq.eq($lazy_eqExprType(0))(x.value1)(y.value1);
                };
                if (x instanceof ConstrainedType && y instanceof ConstrainedType) {
                    return Data_Eq.eq(Data_Eq.eqArray(eqTuple1(Data_Eq.eqArray($lazy_eqExprType(0)))))(x.value0)(y.value0) && Data_Eq.eq($lazy_eqExprType(0))(x.value1)(y.value1);
                };
                return false;
            };
        }
    ...
    return {
        compare: function (x) {
            return function (y) {
                ...
                if (x instanceof $$Array && y instanceof $$Array) {
                    return Data_Ord.compare($lazy_ordExprType(0))(x.value0)(y.value0);
                };
                ...
                if (x instanceof ADT && y instanceof ADT) {
                    ...
                    return Data_Ord.compare(Data_Ord.ordArray($lazy_ordExprType(0)))(x.value2)(y.value2);
                };
                if (x instanceof ADT) {
                    return Data_Ordering.LT.value;
                };
                ...
                if (x instanceof TypeApp && y instanceof TypeApp) {
                    var v = Data_Ord.compare($lazy_ordExprType(0))(x.value0)(y.value0);
                    if (v instanceof Data_Ordering.LT) {
                        return Data_Ordering.LT.value;
                    };
                    if (v instanceof Data_Ordering.GT) {
                    ...
                    return Data_Ord.compare(Data_Ord.ordArray($lazy_ordExprType(0)))(x.value1)(y.value1);
                };
                ...
                if (x instanceof Func && y instanceof Func) {
                    var v = Data_Ord.compare(Data_Ord.ordArray($lazy_ordExprType(0)))(x.value0)(y.value0);
                    if (v instanceof Data_Ordering.LT) {
                        return Data_Ordering.LT.value;
                    };
                    if (v instanceof Data_Ordering.GT) {
                    ...
                    return Data_Ord.compare($lazy_ordExprType(0))(x.value1)(y.value1);
                };
                ...
                if (x instanceof Row && y instanceof Row) {
                    var v = Data_Ord.compare(Data_Ord.ordArray(ordTuple($lazy_ordExprType(0))))(x.value0)(y.value0);
                    if (v instanceof Data_Ordering.LT) {
                        return Data_Ordering.LT.value;
                    };
                    if (v instanceof Data_Ordering.GT) {
                    ...
                    return Data_Ord.compare(Data_Maybe.ordMaybe($lazy_ordExprType(0)))(x.value1)(y.value1);
                };
                if (x instanceof Row) {
                    return Data_Ordering.LT.value;
                };
                ...
                if (x instanceof ConstrainedType && y instanceof ConstrainedType) {
                    var v = Data_Ord.compare(Data_Ord.ordArray(ordTuple1(Data_Ord.ordArray($lazy_ordExprType(0)))))(x.value0)(y.value0);
                    if (v instanceof Data_Ordering.LT) {
                        return Data_Ordering.LT.value;
                    };
                    if (v instanceof Data_Ordering.GT) {
