...
var $lazy_showJCursor = /* #__PURE__ */ $runtime_lazy("showJCursor", "Data.Argonaut.JCursor", function () {
    return {
        show: function (v) {
            ...
            if (v instanceof JField) {
                return "(JField " + (Data_Show.show(Data_Show.showString)(v.value0) + (" " + (Data_Show.show($lazy_showJCursor(0))(v.value1) + ")")));
            };
            if (v instanceof JIndex) {
                return "(JIndex " + (Data_Show.show(Data_Show.showInt)(v.value0) + (" " + (Data_Show.show($lazy_showJCursor(0))(v.value1) + ")")));
            };
            throw new Error("Failed pattern match at Data.Argonaut.JCursor (line 26, column 1 - line 29, column 67): " + [ v.constructor.name ]);
        }
    };
});
var showJCursor = /* #__PURE__ */ $lazy_showJCursor(26);
var $lazy_semigroupJCursor = /* #__PURE__ */ $runtime_lazy("semigroupJCursor", "Data.Argonaut.JCursor", function () {
    return {
        append: function (v) {
            return function (v1) {
                ...
                if (v instanceof JField) {
                    return new JField(v.value0, Data_Semigroup.append($lazy_semigroupJCursor(0))(v.value1)(v1));
                };
                if (v instanceof JIndex) {
                    return new JIndex(v.value0, Data_Semigroup.append($lazy_semigroupJCursor(0))(v.value1)(v1));
                };
...
var semigroupJCursor = /* #__PURE__ */ $lazy_semigroupJCursor(36);
...
var $lazy_eqJCursor = /* #__PURE__ */ $runtime_lazy("eqJCursor", "Data.Argonaut.JCursor", function () {
    return {
        eq: function (x) {
            return function (y) {
                ...
                if (x instanceof JField && y instanceof JField) {
                    return x.value0 === y.value0 && Data_Eq.eq($lazy_eqJCursor(0))(x.value1)(y.value1);
                };
...
var eqJCursor = /* #__PURE__ */ $lazy_eqJCursor(23);
var $lazy_ordJCursor = /* #__PURE__ */ $runtime_lazy("ordJCursor", "Data.Argonaut.JCursor", function () {
    return {
        compare: function (x) {
            return function (y) {
                if (x instanceof JCursorTop && y instanceof JCursorTop) {
                ...
                if (x instanceof JField && y instanceof JField) {
                    ...
                    return Data_Ord.compare($lazy_ordJCursor(0))(x.value1)(y.value1);
                };
...
var ordJCursor = /* #__PURE__ */ $lazy_ordJCursor(24);
...
var decodeJsonJCursor = {
    decodeJson: function (j) {
        var goNum = function (c) {
            var $157 = Data_Maybe.maybe(Data_Function.apply(Data_Either.Left.create)(new Data_Argonaut_Decode_Error.TypeMismatch("Int")))((function () {
        ...
        var goLoop = function (v) {
            return Control_Bind.bind(Data_Either.bindEither)(loop(v.value1))(function (c) {
                var fail = new Data_Either.Left(Data_Function.apply(Data_Argonaut_Decode_Error.Named.create("Int or String"))(new Data_Argonaut_Decode_Error.UnexpectedValue(v.value0)));
