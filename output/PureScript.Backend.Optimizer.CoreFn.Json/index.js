...
var decodeModuleName = /* #__PURE__ */ (function () {
    var $120 = map((function () {
        var $123 = intercalate(".");
        return function ($124) {
            return PureScript_Backend_Optimizer_CoreFn.ModuleName($123($124));
        };
    })());
    var $121 = decodeArray(decodeString);
    return function ($122) {
        return $120($121($122));
    };
})();
...
var decodeCodePoint = /* #__PURE__ */ Control_Bind.composeKleisliFlipped(Data_Either.bindEither)(/* #__PURE__ */ (function () {
    var $125 = Data_Either.note(new Data_Argonaut_Decode_Error.TypeMismatch("CodePoint"));
    var $126 = Data_Enum.toEnum(Data_String_CodePoints.boundedEnumCodePoint);
    return function ($127) {
        return $125($126($127));
    };
})())(decodeInt);
...
var decodeExprType = function (json) {
    var decodeStr = bind(decodeString(json))(function (str) {
        ...
        return throwError(new Data_Argonaut_Decode_Error.TypeMismatch("ExprType"));
    });
...
var decodeRecord = /* #__PURE__ */ (function () {
    ...
    return function ($128) {
        return decodeArray(decodeProp($128));
    };
})();
