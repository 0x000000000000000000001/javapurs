...
var moduleReachability = function (entryMods) {
    return function (modulesMap) {
        var getModuleDeps = function (modName) {
                    ...
                    return function (v1) {
                        return Data_Foldable.foldl(Data_Set.foldableSet)(function (acc2) {
                            return function (v2) {
                                ...
                                throw new Error("Failed pattern match at PureScript.Backend.Optimizer.Reachability (line 53, column 23 - line 55, column 40): " + [ v2.value0.constructor.name ]);
                            };
            ...
            throw new Error("Failed pattern match at PureScript.Backend.Optimizer.Reachability (line 43, column 5 - line 67, column 18): " + [ v.constructor.name ]);
        };
