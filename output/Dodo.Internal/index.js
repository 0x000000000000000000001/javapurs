...
var $lazy_functorDoc = /* #__PURE__ */ $runtime_lazy("functorDoc", "Dodo.Internal", function () {
    return {
        map: function (f) {
            return function (m) {
                if (m instanceof Append) {
                    return new Append(Data_Functor.map($lazy_functorDoc(0))(f)(m.value0), Data_Functor.map($lazy_functorDoc(0))(f)(m.value1));
                };
                if (m instanceof Indent) {
                    return new Indent(Data_Functor.map($lazy_functorDoc(0))(f)(m.value0));
                };
                if (m instanceof Align) {
                    return new Align(m.value0, Data_Functor.map($lazy_functorDoc(0))(f)(m.value1));
                };
                if (m instanceof Annotate) {
                    return new Annotate(f(m.value0), Data_Functor.map($lazy_functorDoc(0))(f)(m.value1));
                };
                if (m instanceof FlexSelect) {
                    return new FlexSelect(Data_Functor.map($lazy_functorDoc(0))(f)(m.value0), Data_Functor.map($lazy_functorDoc(0))(f)(m.value1), Data_Functor.map($lazy_functorDoc(0))(f)(m.value2));
                };
                if (m instanceof FlexAlt) {
                    return new FlexAlt(Data_Functor.map($lazy_functorDoc(0))(f)(m.value0), Data_Functor.map($lazy_functorDoc(0))(f)(m.value1));
                };
                if (m instanceof WithPosition) {
                    return new WithPosition(Data_Functor.map(Data_Functor.functorFn)(Data_Functor.map($lazy_functorDoc(0))(f))(m.value0));
                };
                if (m instanceof Local) {
                    return new Local(Data_Functor.map(Data_Functor.functorFn)(Data_Functor.map(Data_Tuple.functorTuple)(Data_Functor.map($lazy_functorDoc(0))(f)))(m.value0));
                };
...
var functorDoc = /* #__PURE__ */ $lazy_functorDoc(42);
