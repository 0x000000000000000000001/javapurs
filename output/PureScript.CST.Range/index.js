...
var tokensOfFixityOp = {
    tokensOf: function (v) {
        ...
        if (v instanceof PureScript_CST_Types.FixityType) {
            return Data_Function.apply(PureScript_CST_Range_TokenList.cons(v.value0))(Data_Semigroup.append(PureScript_CST_Range_TokenList.semigroupTokenList)(tokensOf(tokensOfQualifiedName)(v.value1))(Data_Semigroup.append(PureScript_CST_Range_TokenList.semigroupTokenList)(PureScript_CST_Range_TokenList.singleton(v.value2))(tokensOf(tokensOfName)(v.value3))));
        };
...
var tokensOfClassFundep = {
    tokensOf: function (v) {
        if (v instanceof PureScript_CST_Types.FundepDetermined) {
            return Data_Function.apply(PureScript_CST_Range_TokenList.cons(v.value0))(tokensOf(tokensOfNonEmptyArray1)(v.value1));
        };
    ...
    return {
        tokensOf: function (v) {
            if (v.prefix instanceof Data_Maybe.Just) {
                return Data_Function.apply(PureScript_CST_Range_TokenList.cons(v.prefix.value0))(Control_Lazy.defer(PureScript_CST_Range_TokenList.lazyTokenList)(function (v1) {
        ...
        tokensOf: function (v) {
            ...
            if (v instanceof PureScript_CST_Types.RecordField) {
                return Data_Semigroup.append(PureScript_CST_Range_TokenList.semigroupTokenList)(tokensOf(tokensOfName)(v.value0))(Control_Lazy.defer(PureScript_CST_Range_TokenList.lazyTokenList)(function (v1) {
                    return Data_Function.apply(PureScript_CST_Range_TokenList.cons(v.value1))(tokensOf(dictTokensOf)(v.value2));
                }));
            };
        ...
        tokensOf: function (v) {
            return Data_Semigroup.append(PureScript_CST_Range_TokenList.semigroupTokenList)(tokensOf(dictTokensOf)(v.head))(Control_Lazy.defer(PureScript_CST_Range_TokenList.lazyTokenList)(function (v1) {
                return Data_Foldable.foldMap(Data_Foldable.foldableArray)(PureScript_CST_Range_TokenList.monoidTokenList)(function (v2) {
                    return Data_Function.apply(PureScript_CST_Range_TokenList.cons(v2.value0))(Control_Lazy.defer(PureScript_CST_Range_TokenList.lazyTokenList)(function (v3) {
    ...
    return {
        tokensOf: function (v) {
            ...
            if (v instanceof PureScript_CST_Types.ExportTypeOp) {
                return Data_Function.apply(PureScript_CST_Range_TokenList.cons(v.value0))(tokensOf(tokensOfName)(v.value1));
            };
...
var tokensOfImportDecl = function (dictTokensOf) {
    ...
    return {
        tokensOf: function (v) {
            return Data_Function.apply(PureScript_CST_Range_TokenList.cons(v.keyword))(Control_Lazy.defer(PureScript_CST_Range_TokenList.lazyTokenList)(function (v1) {
    ...
    return {
        tokensOf: function (v) {
            ...
            if (v instanceof PureScript_CST_Types.TypeForall) {
                return Data_Function.apply(PureScript_CST_Range_TokenList.cons(v.value0))(Control_Lazy.defer(PureScript_CST_Range_TokenList.lazyTokenList)(function (v1) {
    ...
    return {
        tokensOf: function (v) {
            return Data_Semigroup.append(PureScript_CST_Range_TokenList.semigroupTokenList)(Data_Foldable.foldMap(Data_Foldable.foldableMaybe)(PureScript_CST_Range_TokenList.monoidTokenList)(tokensOf(tokensOfSeparated(tokensOfLabeled1(tokensOfType(dictTokensOf)))))(v.labels))(Data_Foldable.foldMap(Data_Foldable.foldableMaybe)(PureScript_CST_Range_TokenList.monoidTokenList)(function (v1) {
                return Data_Function.apply(PureScript_CST_Range_TokenList.cons(v1.value0))(tokensOf(tokensOfType(dictTokensOf))(v1.value1));
            })(v.tail));
        }
    };
};
    ...
    return {
        tokensOf: function (v) {
            ...
            if (v instanceof PureScript_CST_Types.BinderNamed) {
                return Data_Semigroup.append(PureScript_CST_Range_TokenList.semigroupTokenList)(tokensOf(tokensOfName)(v.value0))(Control_Lazy.defer(PureScript_CST_Range_TokenList.lazyTokenList)(function (v1) {
                    return Data_Function.apply(PureScript_CST_Range_TokenList.cons(v.value1))(tokensOf(tokensOfBinder(dictTokensOf))(v.value2));
                }));
            };
            ...
            if (v instanceof PureScript_CST_Types.BinderTyped) {
                return Data_Semigroup.append(PureScript_CST_Range_TokenList.semigroupTokenList)(tokensOf(tokensOfBinder(dictTokensOf))(v.value0))(Control_Lazy.defer(PureScript_CST_Range_TokenList.lazyTokenList)(function (v1) {
                    return Data_Function.apply(PureScript_CST_Range_TokenList.cons(v.value1))(tokensOf(tokensOfType1)(v.value2));
                }));
            };
    ...
    return {
        tokensOf: function (v) {
            ...
            if (v instanceof PureScript_CST_Types.ForeignData) {
                return Data_Function.apply(PureScript_CST_Range_TokenList.cons(v.value0))(tokensOf(tokensOfLabeled2)(v.value1));
            };
        ...
        tokensOf: function (v) {
            return Data_Semigroup.append(PureScript_CST_Range_TokenList.semigroupTokenList)(tokensOf(tokensOfExpr(dictTokensOf))(v.expr))(Control_Lazy.defer(PureScript_CST_Range_TokenList.lazyTokenList)(function (v1) {
                return Data_Foldable.foldMap(Data_Foldable.foldableMaybe)(PureScript_CST_Range_TokenList.monoidTokenList)(function (v2) {
                    return Data_Function.apply(PureScript_CST_Range_TokenList.cons(v2.value0))(tokensOf(tokensOfNonEmptyArray(tokensOfLetBinding(dictTokensOf)))(v2.value1));
                })(v.bindings);
            }));
        }
    };
        ...
        tokensOf: function (v) {
            ...
            if (v instanceof PureScript_CST_Types.LetBindingPattern) {
                return Data_Semigroup.append(PureScript_CST_Range_TokenList.semigroupTokenList)(tokensOf(tokensOfBinder1)(v.value0))(Control_Lazy.defer(PureScript_CST_Range_TokenList.lazyTokenList)(function (v1) {
                    return Data_Function.apply(PureScript_CST_Range_TokenList.cons(v.value1))(tokensOf(tokensOfWhere(dictTokensOf))(v.value2));
                }));
            };
...
var tokensOfGuardedExpr = function (dictTokensOf) {
    return {
        tokensOf: function (v) {
            return Data_Function.apply(PureScript_CST_Range_TokenList.cons(v.bar))(Control_Lazy.defer(PureScript_CST_Range_TokenList.lazyTokenList)(function (v1) {
    ...
    return {
        tokensOf: function (v) {
            if (v instanceof PureScript_CST_Types.Unconditional) {
                return Data_Function.apply(PureScript_CST_Range_TokenList.cons(v.value0))(tokensOf(tokensOfWhere(dictTokensOf))(v.value1));
            };
    ...
    return {
        tokensOf: function (v) {
            ...
            if (v instanceof PureScript_CST_Types.ExprNegate) {
                return Data_Function.apply(PureScript_CST_Range_TokenList.cons(v.value0))(tokensOf(tokensOfExpr(dictTokensOf))(v.value1));
            };
            if (v instanceof PureScript_CST_Types.ExprRecordAccessor) {
                return Data_Semigroup.append(PureScript_CST_Range_TokenList.semigroupTokenList)(tokensOf(tokensOfExpr(dictTokensOf))(v.value0.expr))(Control_Lazy.defer(PureScript_CST_Range_TokenList.lazyTokenList)(function (v1) {
                    return Data_Function.apply(PureScript_CST_Range_TokenList.cons(v.value0.dot))(tokensOf(tokensOfSeparated1)(v.value0.path));
                }));
            };
            ...
            if (v instanceof PureScript_CST_Types.ExprLambda) {
                return Data_Function.apply(PureScript_CST_Range_TokenList.cons(v.value0.symbol))(Control_Lazy.defer(PureScript_CST_Range_TokenList.lazyTokenList)(function (v1) {
            ...
            if (v instanceof PureScript_CST_Types.ExprIf) {
                return Data_Function.apply(PureScript_CST_Range_TokenList.cons(v.value0.keyword))(Control_Lazy.defer(PureScript_CST_Range_TokenList.lazyTokenList)(function (v1) {
    ...
    return {
        tokensOf: function (v) {
            ...
            if (v instanceof PureScript_CST_Types.DoBind) {
                return Data_Semigroup.append(PureScript_CST_Range_TokenList.semigroupTokenList)(tokensOf(tokensOfBinder1)(v.value0))(Control_Lazy.defer(PureScript_CST_Range_TokenList.lazyTokenList)(function (v1) {
                    return Data_Function.apply(PureScript_CST_Range_TokenList.cons(v.value1))(tokensOf(tokensOfExpr(dictTokensOf))(v.value2));
                }));
            };
...
var tokensOfInstance = function (dictTokensOf) {
    ...
    return {
        tokensOf: function (v) {
            return Data_Function.apply(PureScript_CST_Range_TokenList.cons(v.head.keyword))(Control_Lazy.defer(PureScript_CST_Range_TokenList.lazyTokenList)(function (v1) {
                return Data_Semigroup.append(PureScript_CST_Range_TokenList.semigroupTokenList)(Data_Foldable.foldMap(Data_Foldable.foldableMaybe)(PureScript_CST_Range_TokenList.monoidTokenList)(function (v2) {
                    ...
                    return Data_Function.apply(PureScript_CST_Range_TokenList.cons(v2.value0))(tokensOf(tokensOfNonEmptyArray2)(v2.value1));
                })(v.body)))));
            }));
        }
    };
    ...
    return {
        tokensOf: function (v) {
            if (v instanceof PureScript_CST_Types.DeclData) {
                return Data_Function.apply(PureScript_CST_Range_TokenList.cons(v.value0.keyword))(Control_Lazy.defer(PureScript_CST_Range_TokenList.lazyTokenList)(function (v1) {
                    return Data_Semigroup.append(PureScript_CST_Range_TokenList.semigroupTokenList)(tokensOf(tokensOfName)(v.value0.name))(Data_Semigroup.append(PureScript_CST_Range_TokenList.semigroupTokenList)(tokensOf(tokensOfArray1)(v.value0.vars))(Data_Foldable.foldMap(Data_Foldable.foldableMaybe)(PureScript_CST_Range_TokenList.monoidTokenList)(function (v2) {
                        return Data_Function.apply(PureScript_CST_Range_TokenList.cons(v2.value0))(tokensOf(tokensOfSeparated3)(v2.value1));
                    })(v.value1)));
                }));
            };
            ...
            if (v instanceof PureScript_CST_Types.DeclClass) {
                return Data_Function.apply(PureScript_CST_Range_TokenList.cons(v.value0.keyword))(Control_Lazy.defer(PureScript_CST_Range_TokenList.lazyTokenList)(function (v1) {
                    return Data_Semigroup.append(PureScript_CST_Range_TokenList.semigroupTokenList)(Data_Foldable.foldMap(Data_Foldable.foldableMaybe)(PureScript_CST_Range_TokenList.monoidTokenList)(function (v2) {
                        ...
                        return Data_Function.apply(PureScript_CST_Range_TokenList.cons(v2.value0))(tokensOf(tokensOfSeparated2)(v2.value1));
            ...
            if (v instanceof PureScript_CST_Types.DeclFixity) {
                return Data_Function.apply(PureScript_CST_Range_TokenList.cons(v.value0.keyword.value0))(Control_Lazy.defer(PureScript_CST_Range_TokenList.lazyTokenList)(function (v1) {
                    return Data_Function.apply(PureScript_CST_Range_TokenList.cons(v.value0.prec.value0))(tokensOf(tokensOfFixityOp)(v.value0.operator));
                }));
            };
            if (v instanceof PureScript_CST_Types.DeclForeign) {
                return Data_Function.apply(PureScript_CST_Range_TokenList.cons(v.value0))(Control_Lazy.defer(PureScript_CST_Range_TokenList.lazyTokenList)(function (v1) {
                    return Data_Function.apply(PureScript_CST_Range_TokenList.cons(v.value1))(tokensOf(tokensOfForeign1)(v.value2));
                }));
            };
        ...
        rangeOf: function (v) {
            if (v instanceof PureScript_CST_Types.DeclData) {
                var v1 = (function () {
                    ...
                    if (v.value1 instanceof Data_Maybe.Just) {
                        return Data_Function.apply(rangeOf1)(Data_Function.apply(Data_Maybe.maybe(v.value1.value0.value1.head)(Data_Tuple.snd))(Data_Array.last(v.value1.value0.value1.tail)));
                    };
