    ...
    map: function (f) {
        return function (m) {
            ...
            if (m instanceof TypeApp) {
                return new TypeApp(f(m.value0), m.value1);
            };
            if (m instanceof Abs) {
...
var $lazy_traversablePair = /* #__PURE__ */ $runtime_lazy("traversablePair", "PureScript.Backend.Optimizer.Syntax", function () {
    return {
        sequence: function (dictApplicative) {
            return function (a) {
                return Data_Traversable.sequenceDefault($lazy_traversablePair(0))(dictApplicative)(a);
            };
        },
...
var $lazy_traversableBackendOperato = /* #__PURE__ */ $runtime_lazy("traversableBackendOperato", "PureScript.Backend.Optimizer.Syntax", function () {
    return {
        sequence: function (dictApplicative) {
            return function (a) {
                return Data_Traversable.sequenceDefault($lazy_traversableBackendOperato(0))(dictApplicative)(a);
            };
        },
        traverse: function (dictApplicative) {
            var Functor0 = (dictApplicative.Apply0()).Functor0();
...
var $lazy_traversableBackendEffect = /* #__PURE__ */ $runtime_lazy("traversableBackendEffect", "PureScript.Backend.Optimizer.Syntax", function () {
    return {
        sequence: function (dictApplicative) {
            return function (a) {
                return Data_Traversable.sequenceDefault($lazy_traversableBackendEffect(0))(dictApplicative)(a);
            };
        },
        traverse: function (dictApplicative) {
            var Functor0 = (dictApplicative.Apply0()).Functor0();
...
var $lazy_traversableBackendSyntax = /* #__PURE__ */ $runtime_lazy("traversableBackendSyntax", "PureScript.Backend.Optimizer.Syntax", function () {
    return {
        sequence: function (dictApplicative) {
            return function (a) {
                return Data_Traversable.sequenceDefault($lazy_traversableBackendSyntax(0))(dictApplicative)(a);
            };
        },
        traverse: function (dictApplicative) {
            var Functor0 = (dictApplicative.Apply0()).Functor0();
            ...
            return function (f) {
                return function (v) {
                    ...
                    if (v instanceof TypeApp) {
                        return Control_Apply.apply(Apply0)(Data_Functor.map(Functor0)(TypeApp.create)(f(v.value0)))(Control_Applicative.pure(dictApplicative)(v.value1));
                    };
                    if (v instanceof Abs) {
...
var eqBackendOperatorNum = {
    eq: function (x) {
        return function (y) {
            ...
            if (x instanceof OpMod && y instanceof OpMod) {
                return true;
            };
            return false;
        };
...
var ordBackendOperatorNum = {
    compare: function (x) {
        return function (y) {
            ...
            if (x instanceof OpSubtract) {
                return Data_Ordering.LT.value;
            };
            if (y instanceof OpSubtract) {
                return Data_Ordering.GT.value;
            };
            if (x instanceof OpMod && y instanceof OpMod) {
                return Data_Ordering.EQ.value;
        ...
        eq: function (x) {
            return function (y) {
                ...
                if (x instanceof TypeApp && y instanceof TypeApp) {
                    return Data_Eq.eq(dictEq)(x.value0)(y.value0) && Data_Eq.eq(PureScript_Backend_Optimizer_CoreFn.eqExprType)(x.value1)(y.value1);
                };
