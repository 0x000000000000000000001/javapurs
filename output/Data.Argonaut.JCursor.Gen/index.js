...
var genJCursor = function (dictMonadGen) {
    ...
    return function (dictMonadRec) {
        ...
        return function (dictLazy) {
            ...
            return Data_Function.apply(Control_Monad_Gen_Class.resize(dictMonadGen)(Data_Ord.min(Data_Ord.ordInt)(10)))(Control_Monad_Gen_Class.sized(dictMonadGen)(genJCursor$prime));
        };
    };
};
export {
