...
var $lazy_foldableCatList = /* #__PURE__ */ $runtime_lazy("foldableCatList", "Data.CatList", function () {
    return {
        foldMap: function (dictMonoid) {
            return Data_Foldable.foldMapDefaultL($lazy_foldableCatList(0))(dictMonoid);
        },
        foldr: function (f) {
            return function (s) {
                return function (l) {
                    return Data_Foldable.foldrDefault($lazy_foldableCatList(0))(f)(s)(l);
                };
            };
        },
        foldl: function (f) {
...
var foldableCatList = /* #__PURE__ */ $lazy_foldableCatList(151);
...
var $lazy_functorCatList = /* #__PURE__ */ $runtime_lazy("functorCatList", "Data.CatList", function () {
    return {
        map: function (v) {
            return function (v1) {
                if (v1 instanceof CatNil) {
                ...
                if (v1 instanceof CatCons) {
                    ...
                    return cons(v(v1.value0))(Data_Functor.map($lazy_functorCatList(0))(v)(d));
                };
...
var functorCatList = /* #__PURE__ */ $lazy_functorCatList(184);
var singleton = function (a) {
    return cons(a)(CatNil.value);
};
var $lazy_traversableCatList = /* #__PURE__ */ $runtime_lazy("traversableCatList", "Data.CatList", function () {
    return {
            ...
            return function (v) {
                return function (v1) {
                    ...
                    if (v1 instanceof CatCons) {
                        ...
                        return Control_Apply.apply(Apply0)(Data_Functor.map(Functor0)(cons)(v(v1.value0)))(Data_Traversable.traverse($lazy_traversableCatList(0))(dictApplicative)(v)(d));
                    };
        ...
        sequence: function (dictApplicative) {
            ...
            return function (v) {
                ...
                if (v instanceof CatCons) {
                    ...
                    return Control_Apply.apply(Apply0)(Data_Functor.map(Functor0)(cons)(v.value0))(Data_Traversable.sequence($lazy_traversableCatList(0))(dictApplicative)(d));
                };
...
var traversableCatList = /* #__PURE__ */ $lazy_traversableCatList(174);
...
var $lazy_applicativeCatList = /* #__PURE__ */ $runtime_lazy("applicativeCatList", "Data.CatList", function () {
    return {
        pure: singleton,
        Apply0: function () {
...
var $lazy_applyCatList = /* #__PURE__ */ $runtime_lazy("applyCatList", "Data.CatList", function () {
    return {
        apply: Control_Monad.ap($lazy_monadCatList(0)),
        Functor0: function () {
            return functorCatList;
        }
    };
});
var $lazy_bindCatList = /* #__PURE__ */ $runtime_lazy("bindCatList", "Data.CatList", function () {
    return {
...
var $lazy_monadCatList = /* #__PURE__ */ $runtime_lazy("monadCatList", "Data.CatList", function () {
    return {
        Applicative0: function () {
            return $lazy_applicativeCatList(0);
        },
        Bind1: function () {
            return $lazy_bindCatList(0);
        }
    };
});
var applicativeCatList = /* #__PURE__ */ $lazy_applicativeCatList(193);
var applyCatList = /* #__PURE__ */ $lazy_applyCatList(190);
var bindCatList = /* #__PURE__ */ $lazy_bindCatList(196);
var monadCatList = /* #__PURE__ */ $lazy_monadCatList(199);
