...
var usedTopLevel = function (v) {
    return Data_Function.applyFlipped(Data_Function.applyFlipped(v.usages)(Data_Map.keys))(Data_Set.mapMaybe(ordQualified)(function (v1) {
...
var tcoRefBinding = function (ref) {
    return function (v) {
        ...
        if (v.value1 instanceof PureScript_Backend_Optimizer_Syntax.TypeApp) {
            return tcoRefBinding(ref)(v.value1.value0);
        };
        return Data_Maybe.Nothing.value;
    };
};
        ...
        return function (arity) {
            return Control_Bind.bind(Data_Maybe.bindMaybe)(Data_Map_Internal.lookup(ordTcoRef)(ref)(v.tailCalls))(function (numTailCalls) {
                return Control_Bind.bind(Data_Maybe.bindMaybe)(Data_Map_Internal.lookup(ordTcoRef)(ref)(v.usages))(function (v1) {
                    ...
                    if (v2.length === 1) {
                        return Data_Function.apply(Data_Maybe.Just.create)(v2[0] === arity && v1.total === numTailCalls);
                    };
                    return Data_Maybe.Nothing.value;
                });
            });
    ...
    return function (analysis) {
        return function (group) {
            return Control_Bind.discard(Control_Bind.discardUnit)(Control_Bind.bindArray)(Control_Alternative.guard(Control_Alternative.alternativeArray)(isTailCalledIn(analysis)(group)))(function () {
                return Data_Function.apply(nub)(Data_Foldable.foldMap(Data_Array_NonEmpty_Internal.foldableNonEmptyArray)(Data_Monoid.monoidArray)(function (b) {
...
var appArgsAnalysis = function (v) {
    if (v.value1 instanceof PureScript_Backend_Optimizer_Syntax.App) {
        return Data_Semigroup.append(semigroupTcoAnalysis)(appArgsAnalysis(v.value1.value0))(Data_Foldable.foldMap(Data_Array_NonEmpty_Internal.foldableNonEmptyArray)(monoidTcoAnalysis)(tcoAnalysisOf)(v.value1.value1));
    };
    if (v.value1 instanceof PureScript_Backend_Optimizer_Syntax.UncurriedApp) {
        return Data_Semigroup.append(semigroupTcoAnalysis)(appArgsAnalysis(v.value1.value0))(Data_Foldable.foldMap(Data_Foldable.foldableArray)(monoidTcoAnalysis)(tcoAnalysisOf)(v.value1.value1));
    };
    if (v.value1 instanceof PureScript_Backend_Optimizer_Syntax.UncurriedEffectApp) {
        return Data_Semigroup.append(semigroupTcoAnalysis)(appArgsAnalysis(v.value1.value0))(Data_Foldable.foldMap(Data_Foldable.foldableArray)(monoidTcoAnalysis)(tcoAnalysisOf)(v.value1.value1));
    };
    if (v.value1 instanceof PureScript_Backend_Optimizer_Syntax.Typed) {
        return appArgsAnalysis(v.value1.value1);
    };
    if (v.value1 instanceof PureScript_Backend_Optimizer_Syntax.TypeApp) {
        return appArgsAnalysis(v.value1.value0);
    };
    return mempty;
};
var analyze = function (env) {
    return function (v) {
        if (v instanceof PureScript_Backend_Optimizer_Syntax.Var) {
            return Data_Function.apply(TcoExpr.create(tcoCall(new TcoTopLevel(v.value0))(0)(mempty)))(new PureScript_Backend_Optimizer_Syntax.Var(v.value0));
        };
        if (v instanceof PureScript_Backend_Optimizer_Syntax.Local) {
            return Data_Function.apply(TcoExpr.create(tcoCall(new TcoLocal(v.value0, v.value1))(0)(mempty)))(new PureScript_Backend_Optimizer_Syntax.Local(v.value0, v.value1));
        };
        var v1 = function (v2) {
            var v3 = function (v4) {
                var v5 = function (v6) {
                    var v7 = function (v8) {
                        ...
                        if (v instanceof PureScript_Backend_Optimizer_Syntax.Branch) {
                            ...
                            return Data_Function.apply(TcoExpr.create(analysis))(new PureScript_Backend_Optimizer_Syntax.Branch(branches$prime, def$prime));
                        };
