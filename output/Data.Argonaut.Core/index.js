...
var $lazy_eqJson = /* #__PURE__ */ $runtime_lazy("eqJson", "Data.Argonaut.Core", function () {
    return {
        eq: function (j1) {
            return function (j2) {
                return Data_Eq.eq(Data_Ordering.eqOrdering)(Data_Ord.compare($lazy_ordJson(0))(j1)(j2))(Data_Ordering.EQ.value);
            };
        }
    };
});
var $lazy_ordJson = /* #__PURE__ */ $runtime_lazy("ordJson", "Data.Argonaut.Core", function () {
    return {
        compare: function (a) {
            return function (b) {
        ...
        Eq0: function () {
            return $lazy_eqJson(0);
        }
    };
});
var eqJson = /* #__PURE__ */ $lazy_eqJson(55);
var ordJson = /* #__PURE__ */ $lazy_ordJson(58);
var eqJNull = {
    eq: function (v) {
        return function (v1) {
            return true;
