...
var strongIndexed = function (dictStrong) {
    ...
    return {
        first: function (v) {
            return Data_Function.apply(Indexed)(Data_Function.apply(Data_Profunctor.lcmap(Profunctor0)(function (v1) {
...
var wanderIndexed = function (dictWander) {
    ...
    return {
        wander: function (trav) {
            return function (v) {
                return Data_Function.apply(Indexed)(Data_Lens_Internal_Wander.wander(dictWander)(function (dictApplicative) {
