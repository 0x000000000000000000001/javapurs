    ...
    return function (msg) {
        return function (handle) {
            return function (opts) {
                return function (cb) {
                    return Data_Function.apply(Effect_Uncurried.runEffectFn4($foreign.sendOptsCbImpl)(msg)(handle)(opts))(function (err) {
                        return Data_Function.apply(cb)(Data_Nullable.toMaybe(err))();
                    });
                };
            };
        };
...
var unsafeSendCb = function (msg) {
    return function (handle) {
        return function (cb) {
            return Data_Function.apply(Effect_Uncurried.runEffectFn3($foreign.sendCbImpl)(msg)(handle))(function (err) {
                return Data_Function.apply(cb)(Data_Nullable.toMaybe(err))();
            });
        };
    };
...
var lookupEnv = function (k) {
    return Data_Function.apply(Data_Functor.map(Effect.functorEffect)(Foreign_Object.lookup(k)))($foreign.unsafeGetEnv);
};
