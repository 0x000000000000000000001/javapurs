    ...
    return function (v) {
        return {
            ...
            usages: update((function () {
                var $328 = over(Usage)(function (us) {
                    return {
                        access: us.access,
                        arities: us.arities,
                        call: us.call,
                ...
                return function ($329) {
                    return Data_Maybe.Just.create($328($329));
                };
            })())(level)(v.usages)
        };
    };
...
var cased = function (level) {
    return function (v) {
        return {
            ...
            externs: v.externs,
            usages: update((function () {
                var $330 = over(Usage)(function (us) {
                    return {
                        access: us.access,
                        arities: us.arities,
                        call: us.call,
                ...
                return function ($331) {
                    return Data_Maybe.Just.create($330($331));
                };
            })())(level)(v.usages)
        };
    };
...
var analyzeDefault = function (dictHasAnalysis) {
    var $334 = foldMap2(analysisOf(dictHasAnalysis));
    return function ($335) {
        return bump($334($335));
    };
};
var resultOf = function (dictHasAnalysis) {
    var $336 = analysisOf(dictHasAnalysis);
    return function ($337) {
        return (function (v) {
            return v.result;
        })(unwrap($336($337)));
...
var accessed = function (level) {
    return function (v) {
        return {
            ...
            externs: v.externs,
            usages: update((function () {
                var $338 = over(Usage)(function (us) {
                    return {
                        arities: us.arities,
                        call: us.call,
                        captured: us.captured,
                ...
                return function ($339) {
                    return Data_Maybe.Just.create($338($339));
                };
            })())(level)(v.usages)
        };
    };
        ...
        return function (externAnalysis) {
            return function (expr) {
                if (expr instanceof PureScript_Backend_Optimizer_Syntax.Var) {
                    var analysis = bump(externs(usedDep(expr.value0)(mempty2)));
                ...
                if (expr instanceof PureScript_Backend_Optimizer_Syntax.LetRec) {
                    return withResult(resultOf1(expr.value2))(complex(NonTrivial.value)(bound(expr.value0)(bump(append4(foldMap3(function ($340) {
                        return analysisOf1(Data_Tuple.snd($340));
                ...
                if (expr instanceof PureScript_Backend_Optimizer_Syntax.Abs) {
                    return withResult(KnownNeutral.value)(complex(KnownSize.value)(capture(CaptureClosure.value)(foldr(function ($341) {
                        return boundArg(Data_Tuple.snd($341));
                    })(analyzeDefault1(expr))(expr.value0))));
                };
                if (expr instanceof PureScript_Backend_Optimizer_Syntax.UncurriedAbs) {
                    return withResult(KnownNeutral.value)(complex(KnownSize.value)(capture(CaptureClosure.value)(foldr1(function ($342) {
                        return boundArg(Data_Tuple.snd($342));
                    })(analyzeDefault1(expr))(expr.value0))));
                };
                ...
                if (expr instanceof PureScript_Backend_Optimizer_Syntax.UncurriedEffectAbs) {
                    return withResult(KnownNeutral.value)(complex(KnownSize.value)(capture(CaptureClosure.value)(foldr1(function ($343) {
                        return boundArg(Data_Tuple.snd($343));
                    })(analyzeDefault1(expr))(expr.value0))));
                };
                ...
                var v = function (v1) {
                    ...
                    if (expr instanceof PureScript_Backend_Optimizer_Syntax.CtorSaturated) {
                        return withResult(KnownNeutral.value)(bump(usedDep(expr.value0)(foldMap4(foldMap5(analysisOf1))(expr.value4))));
                    };
                    ...
                    if (expr instanceof PureScript_Backend_Optimizer_Syntax.Branch) {
                        ...
                        var result = foldMap1(function ($344) {
                            return resultOf1(PureScript_Backend_Optimizer_Syntax.sndPair($344));
                        })(expr.value0);
                        return withResult(result)(complex(NonTrivial.value)(append4(analysisOf1(v2.value0))(append4(capture(CaptureBranch.value)(analysisOf1(v2.value1)))(append4(capture(CaptureBranch.value)(foldMap4(foldMap6(analysisOf1))(Data_Array_NonEmpty.tail(expr.value0))))(capture(CaptureBranch.value)(analysisOf1(expr.value1)))))));
                    };
                    ...
                    if (expr instanceof PureScript_Backend_Optimizer_Syntax.PrimOp) {
                        ...
                        if (expr.value0 instanceof PureScript_Backend_Optimizer_Syntax.Op1 && expr.value0.value0 instanceof PureScript_Backend_Optimizer_Syntax.OpIsTag) {
                            var $257 = syntaxOf(expr.value0.value1);
                            if ($257 instanceof Data_Maybe.Just && $257.value0 instanceof PureScript_Backend_Optimizer_Syntax.Local) {
                                return cased($257.value0.value1)(usedDep(expr.value0.value0.value0)(analysis));
                            };
                            return v2(true);
                        };
                        return v2(true);
                    ...
                    if (expr instanceof PureScript_Backend_Optimizer_Syntax.Accessor) {
                        ...
                        if (v2 instanceof Data_Maybe.Just && v2.value0 instanceof PureScript_Backend_Optimizer_Syntax.Var) {
                            ...
                            if (expr.value1 instanceof PureScript_Backend_Optimizer_Syntax.GetProp) {
                                var $281 = externAnalysis(v2.value0.value0)(new Data_Maybe.Just(expr.value1.value0));
                                if ($281 instanceof Data_Maybe.Just) {
                                    return withArgs($281.value0.args)(complex(Trivial.value)(analysis));
                                };
                                return v3(true);
                            };
                            return v3(true);
                ...
                if (expr instanceof PureScript_Backend_Optimizer_Syntax.App) {
                    var $297 = analysisOf1(expr.value0);
                    var remainingArgs = Data_Array.drop(Data_Array_NonEmpty.length(expr.value1))($297.args);
                    var analysis = (function () {
    ...
    return function (dictHasSyntax) {
        ...
        return function (externAnalysis) {
            return function (expr) {
                ...
                if (expr instanceof PureScript_Backend_Optimizer_Syntax.LetRec) {
                    return withResult(resultOf1(expr.value2))(complex(NonTrivial.value)(bound(expr.value0)(bump(append4(foldMap3(function ($345) {
                        return analysisOf1(Data_Tuple.snd($345));
                    })(expr.value1))(analysisOf1(expr.value2))))));
                };
                if (expr instanceof PureScript_Backend_Optimizer_Syntax.EffectBind) {
