...
var permsToInt = /* #__PURE__ */ Data_Function.apply(Partial_Unsafe.unsafePartial)(function () {
...
var permFromChar = function (c) {
    if (c === "0") {
        return Data_Function.apply(Data_Maybe.Just.create)(none);
    };
    if (c === "1") {
        return Data_Function.apply(Data_Maybe.Just.create)(execute);
    };
    if (c === "2") {
        return Data_Function.apply(Data_Maybe.Just.create)(write);
    };
    if (c === "3") {
        return Data_Function.apply(Data_Maybe.Just.create)(Data_Semiring.add(semiringPerm)(write)(execute));
    };
    if (c === "4") {
        return Data_Function.apply(Data_Maybe.Just.create)(read);
    };
    if (c === "5") {
        return Data_Function.apply(Data_Maybe.Just.create)(Data_Semiring.add(semiringPerm)(read)(execute));
    };
    if (c === "6") {
        return Data_Function.apply(Data_Maybe.Just.create)(Data_Semiring.add(semiringPerm)(read)(write));
    };
    if (c === "7") {
        return Data_Function.apply(Data_Maybe.Just.create)(Data_Semiring.add(semiringPerm)(Data_Semiring.add(semiringPerm)(read)(write))(execute));
    };
    return Data_Maybe.Nothing.value;
};
var permsFromString = /* #__PURE__ */ (function () {
    var zeroChar = Data_Function.apply(Partial_Unsafe.unsafePartial)(function () {
        return Data_Function.apply(fromJust1)(Data_Enum.toEnum(Data_Enum.boundedEnumChar)(48));
    });
...
var showPerms = {
    show: function (v) {
        var f = function (perm) {
            ...
            var $110 = Data_Function.apply(Data_Maybe.isNothing)(Data_String_CodePoints.indexOf(" ")(str));
            if ($110) {
                return str;
            };
            return "(" + (str + ")");
