...
var unsafeView = function () {
    return function (s) {
        return function (l) {
            return Data_Function.apply(Data_Maybe["fromMaybe$prime"](function (v) {
...
var unsafeIndexedFold = function () {
    return function (s) {
        return function (l) {
            ...
            }))(Data_Function.apply(unwrap)(Data_Lens_Fold.ifoldMapOf(l)(function (i) {
                return function (a) {
                    return Data_Function.apply(Data_Maybe_First.First)(new Data_Maybe.Just(new Data_Tuple.Tuple(i, a)));
                };
            })(s)));
        };
    };
