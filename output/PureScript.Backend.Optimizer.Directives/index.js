...
var qualified = /* #__PURE__ */ expectMap(function (v) {
    if (v.value instanceof PureScript_CST_Types.TokLowerName && v.value.value0 instanceof Data_Maybe.Just) {
        return Data_Function.apply(Data_Maybe.Just.create)(new PureScript_Backend_Optimizer_CoreFn.Qualified(new Data_Maybe.Just(v.value.value0.value0), v.value.value1));
    };
    return Data_Maybe.Nothing.value;
});
var unqualified = /* #__PURE__ */ expectMap(function (v) {
    if (v.value instanceof PureScript_CST_Types.TokLowerName && v.value.value0 instanceof Data_Maybe.Nothing) {
        return Data_Function.apply(Data_Maybe.Just.create)(v.value.value1);
    };
    return Data_Maybe.Nothing.value;
});
    ...
    var go = function (v) {
        return function (v1) {
            ...
            if (v1 instanceof PureScript_Backend_Optimizer_CoreFn.LineComment) {
                var $83 = Data_Function.apply(Data_String_CodeUnits.stripPrefix("@inline"))(Data_String_Common.trim(v1.value0));
