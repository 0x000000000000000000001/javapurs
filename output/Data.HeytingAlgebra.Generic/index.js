...
var genericNot = function (dictGeneric) {
    ...
    return function (dictGenericHeytingAlgebra) {
        return function (x) {
            return Data_Function.apply(to)(genericNot$prime(dictGenericHeytingAlgebra)(Data_Generic_Rep.from(dictGeneric)(x)));
        };
    };
};
...
var genericImplies = function (dictGeneric) {
    ...
    return function (dictGenericHeytingAlgebra) {
        return function (x) {
            return function (y) {
                return Data_Function.apply(to)(genericImplies$prime(dictGenericHeytingAlgebra)(Data_Generic_Rep.from(dictGeneric)(x))(Data_Generic_Rep.from(dictGeneric)(y)));
            };
        };
    };
};
...
var genericDisj = function (dictGeneric) {
    ...
    return function (dictGenericHeytingAlgebra) {
        return function (x) {
            return function (y) {
                return Data_Function.apply(to)(genericDisj$prime(dictGenericHeytingAlgebra)(Data_Generic_Rep.from(dictGeneric)(x))(Data_Generic_Rep.from(dictGeneric)(y)));
            };
        };
    };
};
...
var genericConj = function (dictGeneric) {
    ...
    return function (dictGenericHeytingAlgebra) {
        return function (x) {
            return function (y) {
                return Data_Function.apply(to)(genericConj$prime(dictGenericHeytingAlgebra)(Data_Generic_Rep.from(dictGeneric)(x))(Data_Generic_Rep.from(dictGeneric)(y)));
            };
        };
    };
};
