...
var statusChangedTime = function (s) {
    var v = Data_Function.apply(Data_JSDate.toDateTime)($foreign.statusChangedTimeImpl(s));
    if (v instanceof Data_Maybe.Just) {
        return v.value0;
    };
    if (v instanceof Data_Maybe.Nothing) {
        return Data_Function.apply(Partial_Unsafe.unsafeCrashWith)("Impossible: `statusChangedTime` returned invalid DateTime value.");
    };
...
var modifiedTime = function (s) {
    var v = Data_Function.apply(Data_JSDate.toDateTime)($foreign.modifiedTimeImpl(s));
    if (v instanceof Data_Maybe.Just) {
        return v.value0;
    };
    if (v instanceof Data_Maybe.Nothing) {
        return Data_Function.apply(Partial_Unsafe.unsafeCrashWith)("Impossible: `modifiedTime` returned invalid DateTime value.");
    };
...
var birthTime = function (s) {
    var v = Data_Function.apply(Data_JSDate.toDateTime)($foreign.birthTimeImpl(s));
    if (v instanceof Data_Maybe.Just) {
        return v.value0;
    };
    if (v instanceof Data_Maybe.Nothing) {
        return Data_Function.apply(Partial_Unsafe.unsafeCrashWith)("Impossible: `birthTime` returned invalid DateTime value.");
    };
...
var accessedTime = function (s) {
    var v = Data_Function.apply(Data_JSDate.toDateTime)($foreign.accessedTimeImpl(s));
    if (v instanceof Data_Maybe.Just) {
        return v.value0;
    };
    if (v instanceof Data_Maybe.Nothing) {
        return Data_Function.apply(Partial_Unsafe.unsafeCrashWith)("Impossible: `accessedTime` returned invalid DateTime value.");
    };
