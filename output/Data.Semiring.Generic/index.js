...
var genericMul = function (dictGeneric) {
    ...
    return function (dictGenericSemiring) {
        return function (x) {
            return function (y) {
                return Data_Function.apply(to)(genericMul$prime(dictGenericSemiring)(Data_Generic_Rep.from(dictGeneric)(x))(Data_Generic_Rep.from(dictGeneric)(y)));
            };
        };
    };
};
...
var genericAdd = function (dictGeneric) {
    ...
    return function (dictGenericSemiring) {
        return function (x) {
            return function (y) {
                return Data_Function.apply(to)(genericAdd$prime(dictGenericSemiring)(Data_Generic_Rep.from(dictGeneric)(x))(Data_Generic_Rep.from(dictGeneric)(y)));
            };
        };
    };
};
