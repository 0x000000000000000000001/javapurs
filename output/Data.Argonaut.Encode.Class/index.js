    ...
    return function () {
        return {
            encodeJson: function (rec) {
                return Data_Function.apply(Data_Argonaut_Core.fromObject)(gEncodeJson(dictGEncodeJson)(rec)(Type_Proxy["Proxy"].value));
            }
        };
    };
};
            ...
            return function () {
                return {
                    gEncodeJson: function (row) {
                        return function (v) {
                            return Foreign_Object.insert(Data_Symbol.reflectSymbol(dictIsSymbol)(Type_Proxy["Proxy"].value))(Data_Function.apply(encodeJson1)(Record.get(dictIsSymbol)()(Type_Proxy["Proxy"].value)(row)))(gEncodeJson(dictGEncodeJson)(row)(Type_Proxy["Proxy"].value));
                        };
                    }
                };
            };
