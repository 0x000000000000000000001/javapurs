...
var sanitizeName = function (name) {
    var s1 = Data_Function.apply(Data_String_Common.replaceAll("/")("_slash_"))(Data_Function.apply(Data_String_Common.replaceAll("\\")("_bslash_"))(Data_Function.apply(Data_String_Common.replaceAll("<")("_less_"))(Data_Function.apply(Data_String_Common.replaceAll(">")("_greater_"))(Data_Function.apply(Data_String_Common.replaceAll("=")("_eq_"))(Data_Function.apply(Data_String_Common.replaceAll("+")("_plus_"))(Data_Function.apply(Data_String_Common.replaceAll("-")("_minus_"))(Data_Function.apply(Data_String_Common.replaceAll("*")("_times_"))(Data_Function.apply(Data_String_Common.replaceAll(":")("_colon_"))(Data_Function.apply(Data_String_Common.replaceAll("|")("_bar_"))(Data_Function.apply(Data_String_Common.replaceAll("&")("_amp_"))(Data_Function.apply(Data_String_Common.replaceAll("^")("_caret_"))(Data_Function.apply(Data_String_Common.replaceAll("~")("_tilde_"))(Data_Function.apply(Data_String_Common.replaceAll("?")("_qmark_"))(Data_Function.apply(Data_String_Common.replaceAll("!")("_bang_"))(Data_Function.apply(Data_String_Common.replaceAll("@")("_at_"))(Data_Function.apply(Data_String_Common.replaceAll("#")("_hash_"))(Data_Function.apply(Data_String_Common.replaceAll("%")("_percent_"))(Data_Function.apply(Data_String_Common.replaceAll("\"")("_quote_"))(Data_Function.apply(Data_String_Common.replaceAll(".")("_dot_"))(Data_Function.apply(Data_String_Common.replaceAll("'")("_prime_"))(Data_String_Common.replaceAll("$")("_dollar_")(name))))))))))))))))))))));
...
var paramTypes = function (v) {
    ...
    if (v.value1 instanceof PureScript_Backend_Optimizer_Syntax.PrimEffect) {
        if (v.value1.value0 instanceof PureScript_Backend_Optimizer_Syntax.EffectRefNew) {
            return paramTypes(v.value1.value0.value0);
        };
