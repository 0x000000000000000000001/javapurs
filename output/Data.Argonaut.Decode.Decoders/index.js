...
var getField = function (decoder) {
    return function (obj) {
        return function (str) {
            return Data_Maybe.maybe(Data_Function.apply(Data_Either.Left.create)(new Data_Argonaut_Decode_Error.AtKey(str, Data_Argonaut_Decode_Error.MissingValue.value)))((function () {
...
var decodeVoid = function (v) {
    return Data_Function.apply(Data_Either.Left.create)(Data_Function.apply(Data_Argonaut_Decode_Error.UnexpectedValue.create)(Data_Argonaut_Core.fromString("Value cannot be Void")));
};
var decodeString = /* #__PURE__ */ (function () {
    return Data_Argonaut_Core.caseJsonString(Data_Function.apply(Data_Either.Left.create)(new Data_Argonaut_Decode_Error.TypeMismatch("String")))(Data_Either.Right.create);
})();
var decodeNumber = /* #__PURE__ */ (function () {
    return Data_Argonaut_Core.caseJsonNumber(Data_Function.apply(Data_Either.Left.create)(new Data_Argonaut_Decode_Error.TypeMismatch("Number")))(Data_Either.Right.create);
})();
var decodeNull = /* #__PURE__ */ (function () {
    return Data_Argonaut_Core.caseJsonNull(Data_Function.apply(Data_Either.Left.create)(new Data_Argonaut_Decode_Error.TypeMismatch("null")))(Data_Function.apply(Data_Function["const"])(new Data_Either.Right(Data_Unit.unit)));
})();
var decodeNonEmptyString = function (json) {
    return Control_Bind.bindFlipped(Data_Either.bindEither)(Data_Either.note(Data_Function.apply(Data_Argonaut_Decode_Error.Named.create("NonEmptyString"))(new Data_Argonaut_Decode_Error.UnexpectedValue(json))))(Data_Functor.map(Data_Either.functorEither)(Data_String_NonEmpty_Internal.fromString)(decodeString(json)));
};
...
var decodeEither = function (decoderA) {
    return function (decoderB) {
        return function (json) {
            return Data_Function.apply(Data_Bifunctor.lmap(Data_Bifunctor.bifunctorEither)(Data_Argonaut_Decode_Error.Named.create("Either")))(Control_Bind.bind(Data_Either.bindEither)(decodeJObject(json))(function (obj) {
                return Control_Bind.bind(Data_Either.bindEither)(Data_Function.apply(Data_Either.note(new Data_Argonaut_Decode_Error.AtKey("tag", Data_Argonaut_Decode_Error.MissingValue.value)))(Foreign_Object.lookup("tag")(obj)))(function (tag) {
                    return Control_Bind.bind(Data_Either.bindEither)(Data_Function.apply(Data_Either.note(new Data_Argonaut_Decode_Error.AtKey("value", Data_Argonaut_Decode_Error.MissingValue.value)))(Foreign_Object.lookup("value")(obj)))(function (val) {
                        ...
                        return Data_Function.apply(Data_Either.Left.create)(new Data_Argonaut_Decode_Error.AtKey("tag", new Data_Argonaut_Decode_Error.UnexpectedValue(tag)));
                    });
                });
            }));
        };
...
var decodeCodePoint = function (json) {
    return Control_Bind.bindFlipped(Data_Either.bindEither)(Data_Either.note(Data_Function.apply(Data_Argonaut_Decode_Error.Named.create("CodePoint"))(new Data_Argonaut_Decode_Error.UnexpectedValue(json))))(Data_Functor.map(Data_Either.functorEither)(Data_String_CodePoints.codePointAt(0))(decodeString(json)));
};
var decodeBoolean = /* #__PURE__ */ (function () {
    return Data_Argonaut_Core.caseJsonBoolean(Data_Function.apply(Data_Either.Left.create)(new Data_Argonaut_Decode_Error.TypeMismatch("Boolean")))(Data_Either.Right.create);
})();
