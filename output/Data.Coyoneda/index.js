...
var coyoneda = function (k) {
    return function (fi) {
        return Data_Function.apply(Coyoneda)(Data_Function.apply(Data_Exists.mkExists)(new CoyonedaF(k, fi)));
    };
};
var functorCoyoneda = {
    map: function (f) {
...
var extendCoyoneda = function (dictExtend) {
    return {
        extend: function (f) {
            return function (v) {
                return Data_Exists.runExists(function (v1) {
                    return Data_Function.apply(liftCoyoneda)(Control_Extend.extend(dictExtend)((function () {
...
var comonadCoyoneda = function (dictComonad) {
    ...
    return {
        extract: function (v) {
            return Data_Exists.runExists(function (v1) {
                return Data_Function.apply(v1.value0)(Control_Comonad.extract(dictComonad)(v1.value1));
            })(v);
        },
        Extend0: function () {
...
var applyCoyoneda = function (dictApply) {
    ...
    return {
        apply: function (f) {
            return function (g) {
                return Data_Function.apply(liftCoyoneda)(Control_Apply.apply(dictApply)(lowerCoyoneda(Functor0)(f))(lowerCoyoneda(Functor0)(g)));
            };
        },
        Functor0: function () {
            return functorCoyoneda;
...
var altCoyoneda = function (dictAlt) {
    ...
    return {
        alt: function (x) {
            return function (y) {
                return Data_Function.apply(liftCoyoneda)(Control_Alt.alt(dictAlt)(lowerCoyoneda(Functor0)(x))(lowerCoyoneda(Functor0)(y)));
            };
        },
        Functor0: function () {
            return functorCoyoneda;
