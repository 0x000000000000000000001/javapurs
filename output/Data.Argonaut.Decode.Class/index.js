                                ...
                                if (v1 instanceof Data_Maybe.Just) {
                                    return Control_Bind.bind(Data_Either.bindEither)(Data_Bifunctor.lmap(Data_Bifunctor.bifunctorEither)(Data_Argonaut_Decode_Error.AtKey.create(fieldName))(v1.value0))(function (val) {
                                        return Control_Bind.bind(Data_Either.bindEither)(gDecodeJson(dictGDecodeJson)(object)(Type_Proxy["Proxy"].value))(function (rest) {
                                            return Data_Function.apply(Data_Either.Right.create)(Record.insert(dictIsSymbol)()()(Type_Proxy["Proxy"].value)(val)(rest));
                                        });
                                    });
                                };
                                if (v1 instanceof Data_Maybe.Nothing) {
                                    return Data_Function.apply(Data_Either.Left.create)(new Data_Argonaut_Decode_Error.AtKey(fieldName, Data_Argonaut_Decode_Error.MissingValue.value));
                                };
...
var decodeMap = function (dictOrd) {
    return function (dictDecodeJson) {
        ...
        return function (dictDecodeJson1) {
            return {
                decodeJson: Data_Argonaut_Decode_Decoders.decodeMap(dictOrd)(decodeJson1)(decodeJson(dictDecodeJson1))
            };
        };
    };
};
...
var decodeFieldMaybe = function (dictDecodeJson) {
    var decodeJsonMaybe1 = decodeJsonMaybe(dictDecodeJson);
    return {
        decodeJsonField: function (v) {
            if (v instanceof Data_Maybe.Nothing) {
                return Data_Function.apply(Data_Maybe.Just.create)(new Data_Either.Right(Data_Maybe.Nothing.value));
            };
            if (v instanceof Data_Maybe.Just) {
                return Data_Function.apply(Data_Maybe.Just.create)(decodeJson(decodeJsonMaybe1)(v.value0));
            };
...
var decodeFieldId = function (dictDecodeJson) {
    ...
    return {
        decodeJsonField: function (j) {
            return Data_Functor.map(Data_Maybe.functorMaybe)(decodeJson1)(j);
        }
    };
};
