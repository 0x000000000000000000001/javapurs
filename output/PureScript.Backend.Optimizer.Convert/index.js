...
var append2 = /* #__PURE__ */ Data_Semigroup.append(/* #__PURE__ */ Data_Set.semigroupSet(Data_Ord.ordString));
...
var eq8 = /* #__PURE__ */ Data_Eq.eq(PureScript_Backend_Optimizer_CoreFn.eqMeta);
...
var fromFoldable2 = /* #__PURE__ */ Data_Map_Internal.fromFoldable(PureScript_Backend_Optimizer_Semantics.ordInlineAccessor)(Data_Foldable.foldableArray);
...
var eq9 = /* #__PURE__ */ Data_Eq.eq(PureScript_Backend_Optimizer_Syntax.eqLevel);
...
var eq10 = /* #__PURE__ */ Data_Eq.eq(PureScript_Backend_Optimizer_CoreFn.eqModuleName);
...
var append3 = /* #__PURE__ */ Data_Semigroup.append(/* #__PURE__ */ Data_Map.semigroupSemigroupMap(PureScript_Backend_Optimizer_CoreFn.ordIdent)(Data_Semigroup_First.semigroupFirst));
...
var eq11 = /* #__PURE__ */ Data_Eq.eq(PureScript_Backend_Optimizer_CoreFn.eqIdent);
...
var fromFoldable3 = /* #__PURE__ */ fromFoldable(PureScript_Backend_Optimizer_CoreFn.ordIdent);
...
var fromFoldable4 = /* #__PURE__ */ Data_Map_Internal.fromFoldable(PureScript_Backend_Optimizer_CoreFn.ordProperName)(Data_Foldable.foldableArray);
var fromFoldable5 = /* #__PURE__ */ Data_Map_Internal.fromFoldable(PureScript_Backend_Optimizer_CoreFn.ordIdent)(Data_Array_NonEmpty_Internal.foldableNonEmptyArray);
...
var append4 = /* #__PURE__ */ Data_Semigroup.append(/* #__PURE__ */ Data_Set.semigroupSet(ordQualified));
...
var fromFoldable6 = /* #__PURE__ */ fromFoldable(PureScript_Backend_Optimizer_CoreFn.ordReExport);
var filterWithKey = /* #__PURE__ */ Data_Map_Internal.filterWithKey(PureScript_Backend_Optimizer_Semantics.ordEvalRef);
...
var eq12 = /* #__PURE__ */ Data_Eq.eq(eqPatternCase);
...
var unwrapExternSpine = function (v) {
    if (v instanceof PureScript_Backend_Optimizer_Semantics.ExternApp) {
        return new PureScript_Backend_Optimizer_Semantics.ExternApp(map(PureScript_Backend_Optimizer_Semantics.unwrapSemTyped)(v.value0));
    };
    if (v instanceof PureScript_Backend_Optimizer_Semantics.ExternUncurriedApp) {
        return new PureScript_Backend_Optimizer_Semantics.ExternUncurriedApp(map(PureScript_Backend_Optimizer_Semantics.unwrapSemTyped)(v.value0));
    };
    ...
    return function (group) {
        return function (isDict) {
            return function (expr) {
                ...
                if (v instanceof PureScript_Backend_Optimizer_Semantics.ExprSyntax && (v.value1 instanceof PureScript_Backend_Optimizer_Syntax.Lit && v.value1.value0 instanceof PureScript_Backend_Optimizer_CoreFn.LitRecord)) {
                    var propsWithAnalysis = map(map1(PureScript_Backend_Optimizer_Semantics.freeze))(v.value1.value0.value0);
                    var v1 = PureScript_Backend_Optimizer_Semantics.freeze(expr);
                    return new Data_Tuple.Tuple(new Data_Tuple.Tuple(analysisOf(expr), new PureScript_Backend_Optimizer_Semantics.ExternDict(group, propsWithAnalysis)), v1.value1);
                };
                var v1 = function (v2) {
                    if (v instanceof PureScript_Backend_Optimizer_Semantics.ExprSyntax && v.value1 instanceof PureScript_Backend_Optimizer_Syntax.CtorDef) {
                        ...
                        var meta = Data_Maybe.fromMaybe({
                            ...
                            size: 0
                        })(lookup(v.value1.value1)(env.dataTypes));
                        return new Data_Tuple.Tuple(new Data_Tuple.Tuple(analysisOf(expr), new PureScript_Backend_Optimizer_Semantics.ExternCtor(meta, v.value1.value0, v.value1.value1, v.value1.value2, v.value1.value3)), v3.value1);
                    };
                    var v3 = PureScript_Backend_Optimizer_Semantics.freeze(expr);
                ...
                if (isDict) {
                    var $497 = getLitRecord(v);
                    if ($497 instanceof Data_Maybe.Just) {
                        var propsWithAnalysis = map(map1(PureScript_Backend_Optimizer_Semantics.freeze))($497.value0);
                        var v2 = PureScript_Backend_Optimizer_Semantics.freeze(expr);
                        return new Data_Tuple.Tuple(new Data_Tuple.Tuple(analysisOf(expr), new PureScript_Backend_Optimizer_Semantics.ExternDict(group, propsWithAnalysis)), v2.value1);
                    };
                    return v1(true);
                };
                return v1(true);
...
var toCaseRowVars = function (v) {
    return foldMap((function () {
        var $976 = Data_Function.flip(Data_Map_Internal.singleton)(v.column);
        return function ($977) {
            return Data_Map.SemigroupMap($976($977));
        };
    })())(v.pattern.vars);
};
...
var patternVars = function (v) {
    return append1(toUnfoldable(v.pattern.vars))(foldMap2(patternVars)(v.pattern.subterms));
};
        ...
        var addBinders = function (allFieldsSet) {
            return function (pat) {
                ...
                if (v instanceof PatRecord) {
                    ...
                    var v1 = Data_Array.unzip(map(Data_Array_NonEmpty.head)(Data_Array.groupAllBy(comparing(Data_Tuple.fst))(append1(currentFieldsWithSubterms)(allFieldsWithWildSubterms))));
                    return {
                        column: pat.column,
                            ...
                            return bind(Data_Array.index(next.patterns)(columnIdx))(function (pat) {
                                return pure((function () {
                                    ...
                                    if (v instanceof PatRecord) {
                                        ...
                                        return Data_Maybe.maybe(keys)(append2(keys))(acc);
                                    };
    ...
    return function (env) {
        return function (qual) {
            return function (spine) {
                var spine$prime = map(unwrapExternSpine)(spine);
...
var isTypeClassDictionaryWithProps = function (expr) {
    ...
    if (expr instanceof PureScript_Backend_Optimizer_CoreFn.ExprApp && (expr.value2 instanceof PureScript_Backend_Optimizer_CoreFn.ExprLit && expr.value2.value1 instanceof PureScript_Backend_Optimizer_CoreFn.LitRecord)) {
        var $568 = getConstructorMeta(expr.value1);
        if ($568 instanceof Data_Maybe.Just) {
            var $569 = eq8($568.value0)(PureScript_Backend_Optimizer_CoreFn.IsTypeClassConstructor.value) || eq8($568.value0)(PureScript_Backend_Optimizer_CoreFn.IsNewtype.value);
            if ($569) {
                return new Data_Tuple.Tuple(true, map(PureScript_Backend_Optimizer_CoreFn.propKey)(expr.value2.value1.value0));
            };
            return v(true);
        };
        return v(true);
        ...
        return function (backendExpr) {
            return function (cfn) {
                var fromImpl = (function () {
                    if (impl instanceof PureScript_Backend_Optimizer_Semantics.ExternExpr && (impl.value1 instanceof PureScript_Backend_Optimizer_Syntax.App && impl.value1.value0 instanceof PureScript_Backend_Optimizer_Syntax.Var)) {
                        ...
                        if (v instanceof Data_Maybe.Just) {
                            ...
                            var $583 = Data_Map_Internal.isEmpty(newDirs);
                            if ($583) {
                                return Data_Maybe.Nothing.value;
                            };
                ...
                var fromBackendExpr = (function () {
                    ...
                    if (cfn instanceof PureScript_Backend_Optimizer_CoreFn.ExprAbs && (cfn.value0.meta instanceof Data_Maybe.Just && (eq8(cfn.value0.meta.value0)(PureScript_Backend_Optimizer_CoreFn.IsTypeClassConstructor.value) || eq8(cfn.value0.meta.value0)(PureScript_Backend_Optimizer_CoreFn.IsNewtype.value)))) {
                        return new Data_Maybe.Just(Data_Map_Internal.singleton(PureScript_Backend_Optimizer_Semantics.InlineRef.value)(PureScript_Backend_Optimizer_Semantics.InlineAlways.value));
                    };
                    var v = function (v1) {
                        if (backendExpr instanceof PureScript_Backend_Optimizer_Semantics.ExprSyntax && (backendExpr.value1 instanceof PureScript_Backend_Optimizer_Syntax.App && (backendExpr.value1.value0 instanceof PureScript_Backend_Optimizer_Semantics.ExprSyntax && backendExpr.value1.value0.value1 instanceof PureScript_Backend_Optimizer_Syntax.Var))) {
                            var v2 = bind(lookup2(new PureScript_Backend_Optimizer_Semantics.EvalExtern(backendExpr.value1.value0.value1.value0))(directives))(lookup3(PureScript_Backend_Optimizer_Semantics.InlineRef.value));
                            var v3 = function (v4) {
                                return Data_Maybe.Nothing.value;
                            };
                            if (v2 instanceof Data_Maybe.Just && v2.value0 instanceof PureScript_Backend_Optimizer_Semantics.InlineArity) {
                                var $614 = Data_Array_NonEmpty.length(backendExpr.value1.value1);
                                var $615 = $614 >= v2.value0.value0;
                                if ($615) {
                                    return new Data_Maybe.Just(Data_Map_Internal.singleton(PureScript_Backend_Optimizer_Semantics.InlineRef.value)(PureScript_Backend_Optimizer_Semantics.InlineAlways.value));
                                };
                                return v3(true);
                    ...
                    var $626 = isTypeClassDictionaryWithProps(cfn);
                    if ($626.value0) {
                        return new Data_Maybe.Just(fromFoldable2(append1([ new Data_Tuple.Tuple(PureScript_Backend_Optimizer_Semantics.InlineRef.value, PureScript_Backend_Optimizer_Semantics.InlineAlways.value) ])(map(function (p) {
...
var decompose = function (chosenColumn) {
    var mergeResults = function (l) {
        return function (r) {
            ...
            if (l.match instanceof Data_Maybe.Nothing && r.match instanceof Data_Maybe.Nothing) {
                return {
                    match: r.match,
                    nonMatchesBefore: append1(l.nonMatchesBefore)(r.nonMatchesBefore)
                };
            };
            ...
            if (l.match instanceof Data_Maybe.Just && r.match instanceof Data_Maybe.Nothing) {
                return {
                    ...
                    match: new Data_Maybe.Just({
                        ...
                        nonMatchesAfter: append1(l.match.value0.nonMatchesAfter)(r.nonMatchesBefore)
                    })
                };
            };
    ...
    var checkMatch = function (p) {
        ...
        var $688 = eq9(p.column)(chosenColumn.column);
        if ($688) {
            var $689 = eq12(patternPatCase(p))(PatWild.value) || Data_Function.on(eq12)(patternPatCase)(chosenColumn)(p);
            if ($689) {
                return {
                    nonMatchesBefore: [  ],
                    match: new Data_Maybe.Just({
    ...
    return foldMap3(function (row) {
        ...
        if (v instanceof Data_Maybe.Just) {
            var v1 = PureScript_Backend_Optimizer_Utils.foldl1Array(function (l) {
                var $978 = mergeResults(l);
                return function ($979) {
                    return $978(checkMatch($979));
                };
            })(checkMatch)(v.value0);
            if (v1.match instanceof Data_Maybe.Just) {
                return {
                    ...
                    rowsNoMatch: (function () {
                        var $693 = eq12(patternPatCase(v1.match.value0.match))(PatWild.value);
                        if ($693) {
                            return [ row ];
                        };
                        return [  ];
    ...
    return function (tailRows) {
        var maximumByAll = function (dictFoldable) {
            ...
            return function (f) {
                ...
                return foldl1(keepAllMax)(Data_Maybe.Nothing.value);
            };
        };
        ...
        if (expandIfPossible instanceof Data_Maybe.Nothing) {
            var matchingPatternGroups = mapFlipped1(row0Patterns)(function (v) {
                var matchingCols = foldMapWithIndex(function (rowIdx) {
                    return function (row) {
                        ...
                        if (v1 instanceof Data_Maybe.Just) {
                            return {
                                tailRowIndices: guard(Data_Function.on(eq12)(patternPatCase)(v.value1)(v1.value0))([ rowIdx + 1 | 0 ]),
                                ...
                                aScore: -Data_Array.length(Data_Array.filter((function () {
                                    var $980 = notEq1(PatWild.value);
                                    return function ($981) {
                                        return $980(patternPatCase($981));
                                    };
            ...
            var heuristic = composeKleisli(maximumByAll1(comparing1(function (v) {
                ...
                var $982 = map2(function ($985) {
                    return (function (v) {
                        return v.pattern;
                    })(Data_Array_NonEmpty.head($985));
                });
                var $983 = maximumByAll1(comparing1(function (v) {
                    return v.aScore;
                }));
                return function ($984) {
                    return $982($983($984));
            ...
            var v1 = function (v2) {
                ...
                if (v.value0.meta instanceof Data_Maybe.Just && (v.value0.meta.value0 instanceof PureScript_Backend_Optimizer_CoreFn.IsConstructor && v.value0.meta.value0.value0 instanceof PureScript_Backend_Optimizer_CoreFn.ProductType)) {
                    return ctorPattern(new PatProduct(v.value1, v.value2))(v.value3)(function (idx) {
                        return function (v3) {
                            return new PureScript_Backend_Optimizer_Syntax.GetCtorField(v.value2, PureScript_Backend_Optimizer_CoreFn.ProductType.value, PureScript_Backend_Optimizer_CoreFn.unQualified(v.value1), PureScript_Backend_Optimizer_CoreFn.unQualified(v.value2), "value" + show(idx), idx);
                        };
                    })(identity);
                };
                if (v.value0.meta instanceof Data_Maybe.Just && (v.value0.meta.value0 instanceof PureScript_Backend_Optimizer_CoreFn.IsConstructor && v.value0.meta.value0.value0 instanceof PureScript_Backend_Optimizer_CoreFn.SumType)) {
                    return ctorPattern(new PatSum(v.value1, v.value2))(v.value3)(function (idx) {
                        return function (v3) {
                            return new PureScript_Backend_Optimizer_Syntax.GetCtorField(v.value2, PureScript_Backend_Optimizer_CoreFn.SumType.value, PureScript_Backend_Optimizer_CoreFn.unQualified(v.value1), PureScript_Backend_Optimizer_CoreFn.unQualified(v.value2), "value" + show(idx), idx);
                        };
                    })(identity);
                };
    ...
    return function (expr) {
        var go = (function () {
            ...
            return function (v) {
                    ...
                    return bind1(ask)(function (v1) {
                        var v2 = function (v3) {
                            ...
                            if (v.value1.value0 instanceof Data_Maybe.Just) {
                                var $777 = eq10(v.value1.value0.value0)(v1.currentModule);
                                if ($777) {
                                    var $778 = lookup4(v.value1.value1)(v1.toLevel);
                                    if ($778 instanceof Data_Maybe.Just) {
                                        return buildM(new PureScript_Backend_Optimizer_Syntax.Local(new Data_Maybe.Just(v.value1.value1), $778.value0));
                                    };
                                    return v4(true);
                                };
                                return v4(true);
                        ...
                        if (v.value1.value0 instanceof Data_Maybe.Nothing) {
                            var $784 = lookup4(v.value1.value1)(v1.toLevel);
                            if ($784 instanceof Data_Maybe.Just) {
                                return buildM(new PureScript_Backend_Optimizer_Syntax.Local(new Data_Maybe.Just(v.value1.value1), $784.value0));
                            };
                            return v2(true);
                        };
                        return v2(true);
                ...
                if (v instanceof PureScript_Backend_Optimizer_CoreFn.ExprLit) {
                    return bindFlipped(function ($986) {
                        return buildM(PureScript_Backend_Optimizer_Syntax.Lit.create($986));
                ...
                if (v instanceof PureScript_Backend_Optimizer_CoreFn.ExprAccessor) {
                    return bindFlipped((function () {
                        var $987 = Data_Function.flip(PureScript_Backend_Optimizer_Syntax.Accessor.create)(new PureScript_Backend_Optimizer_Syntax.GetProp(v.value2));
                        return function ($988) {
                            return buildM($987($988));
                        };
                    ...
                    if (v instanceof PureScript_Backend_Optimizer_CoreFn.ExprLet) {
                        var goBind = function (bind$prime) {
                            return function (next) {
                                ...
                                if (bind$prime instanceof PureScript_Backend_Optimizer_CoreFn.Rec) {
                                    var $824 = Data_Array_NonEmpty.fromArray(bind$prime.value0);
                                    if ($824 instanceof Data_Maybe.Just) {
                                        return bind1(currentLevel)(function (lvl) {
                                            ...
                                            })(intro2(idents)(lvl)(traverse3(toBackendBinding)($824.value0))))(intro2(idents)(lvl)(next)));
                                        });
                                    };
                                    return v3(true);
                                };
                        ...
                        return foldr(goBind)(toBackendExpr(v.value2))(v.value1);
                    };
        ...
        return bind1(go(expr))(function (backendExpr) {
            return pure1((function () {
                ...
                if (v1 instanceof Data_Maybe.Just) {
                    return new PureScript_Backend_Optimizer_Semantics.ExprSyntax(analysisOf(backendExpr), new PureScript_Backend_Optimizer_Syntax.Typed(v1.value0, backendExpr));
                };
                if (v1 instanceof Data_Maybe.Nothing) {
                    return backendExpr;
                };
...
var buildCaseTreeFromRows = function (denormalizedRows) {
    ...
    if (v instanceof Data_Maybe.Just) {
        ...
        var row0NonPatWildPatterns = Data_Array_NonEmpty.fromArray(foldlWithIndex(function (idx) {
            return function (acc) {
                return function (p) {
                    var $869 = notEq1(patternPatCase(p))(PatWild.value);
                    if ($869) {
        ...
        var rebuildCaseRow = function (idents) {
            ...
            return map(function (v) {
                ...
                return {
                    ...
                    patterns: append1(v.nonMatchesBefore)(append1(subtermPatterns)(v.nonMatchesAfter))
                };
            });
        };
...
var buildCaseLeaf = function (row0) {
    return function (tailRows) {
        var orderedArgs = toUnfoldable1(coerce(append3(row0.vars)(foldMap4(toCaseRowVars)(row0.patterns))));
...
var toTopLevelBackendBinding = function (group) {
    return function (env) {
        return function (v) {
            ...
            var v2 = (function () {
                var $928 = eq11(v.value1)("contains");
                if ($928) {
                    return trace("OPTIMIZED AST FOR CONTAINS: " + printExpr(optimizedExprWithTy))(function (v3) {
            ...
            return {
                accum: {
                    ...
                    rewriteLimit: env.rewriteLimit,
                    traceIdents: env.traceIdents,
                    implementations: insert3(qualifiedIdent)(v3.value0)(env.implementations),
                    moduleImplementations: insert3(qualifiedIdent)(v3.value0)(env.moduleImplementations),
                    optimizationSteps: Data_Maybe.maybe(env.optimizationSteps)((function () {
                        var $989 = Data_Array.snoc(env.optimizationSteps);
                        var $990 = Data_Tuple.Tuple.create(qualifiedIdent);
                        return function ($991) {
                            return $989($990($991));
                        };
                        ...
                        if (v5 instanceof Data_Maybe.Just) {
                            return alter(function (v6) {
                                if (v6 instanceof Data_Maybe.Just) {
                                    return new Data_Maybe.Just(union(v6.value0)(v5.value0));
                                };
                ...
                value: new Data_Tuple.Tuple(v.value1, new Data_Tuple.Tuple((unwrap(Data_Tuple.fst(v3.value0))).deps, v3.value1))
            };
        };
    };
};
...
var toBackendTopLevelBindingGroups = function (binds) {
    return function (env) {
        ...
        return {
            ...
            })(Data_Array.groupBy(Data_Function.on(conj)(function ($992) {
                return !(function (v1) {
                    return v1.recursive;
                })($992);
            }))(result.value))
...
var toBackendModule = function (v) {
    return function (env) {
        var localExports = fromFoldable3(v.exports);
        var isBindingUsed = function (deps) {
            return function (v1) {
                var res = member1(v1.value0)(localExports) || member(new PureScript_Backend_Optimizer_CoreFn.Qualified(new Data_Maybe.Just(v.name), v1.value0))(deps);
                var $952 = unwrap(v.name) === "Data.Set";
                if ($952) {
                    return res;
                };
                return res;
        ...
        var ctors = bind2(v.dataDecls)(function (decl) {
            return bind2(decl.constructors)(function (ctor) {
                var fieldNames = Data_Array.mapWithIndex(function (i) {
                    return function (v1) {
                        return "value" + show(i);
                    };
                })(ctor.fields);
                return pure2(new Data_Tuple.Tuple(decl.name, new Data_Tuple.Tuple(ctor.name, fieldNames)));
            });
        });
        var dataTypes = fromFoldable4(map(function (group) {
            var proper = Data_Tuple.fst(Data_Array_NonEmpty.head(group));
            var constructors = fromFoldable5(mapWithIndex(function (tag) {
                return function (v1) {
            ...
            var sizes = map4(function ($993) {
                return Data_Array.length(Data_Tuple.snd(Data_Tuple.snd($993)));
            })(group);
        ...
        var usedBindings = mapAccumR(function (deps) {
            return function (group) {
                var v1 = (function () {
                    if (group.recursive) {
                        var $961 = Data_Array.any(isBindingUsed(deps))(group.bindings);
                        if ($961) {
                            return {
                                accum: append4(foldMap5(function ($994) {
                                    return Data_Tuple.fst(Data_Tuple.snd($994));
                                })(group.bindings))(deps),
                                value: map((function () {
                                    var $995 = map5(Data_Tuple.snd);
                                    return function ($996) {
                                        return Data_Maybe.Just.create($995($996));
                                    };
                                })())(group.bindings)
                            };
                        };
                    ...
                    return mapAccumR(function (deps$prime) {
                        return function (v2) {
                            var $963 = isBindingUsed(deps$prime)(v2);
                            if ($963) {
                                return {
                                    accum: append4(v2.value1.value0)(deps$prime),
        ...
        return new Data_Tuple.Tuple(moduleBindings.accum.optimizationSteps, {
            ...
            dataTypes: filter((function () {
                var $997 = Data_Array.any(isBindingUsed(usedBindings.accum));
                return function ($998) {
                    return $997(toUnfoldable1((function (v1) {
