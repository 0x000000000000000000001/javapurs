...
var toModuleName = function (v) {
    ...
    return Data_Function.apply(Data_Maybe.Just.create)(Data_Function.apply(PureScript_CST_Types.ModuleName)(Data_String_CodeUnits.dropRight(1)(v)));
};
...
var oneLineComment = /* #__PURE__ */ Control_Bind.bind(bindLex)(lineComment)(function (line) {
    ...
    return Data_Function.apply(fail)(new PureScript_CST_Errors.LexExpected("one newline", "multiple newlines"));
});
...
var token = /* #__PURE__ */ (function () {
    ...
    var parseRawString = Data_Functor.map(functorLex)(function (v) {
        return Data_Function.apply(PureScript_CST_Types.TokRawString.create)(Data_Function.apply(Data_String_CodeUnits.dropRight(3))(Data_String_CodeUnits.drop(3)(v)));
    })(rawStringCharsRegex);
    ...
    var parseHexInt = Control_Bind.bind(bindLex)(Control_Apply.applySecond(applyLex)(hexIntPrefix)(hexIntRegex))(function (raw) {
        ...
        if (v instanceof Data_Maybe.Just) {
            return Data_Function.apply(pure)(new PureScript_CST_Types.TokInt("0x" + raw, new PureScript_CST_Types.SmallInt(v.value0)));
        };
        if (v instanceof Data_Maybe.Nothing) {
            return Data_Function.apply(pure)(new PureScript_CST_Types.TokInt("0x" + raw, new PureScript_CST_Types.BigHex(raw)));
        };
    ...
    var parseHexEscape = function (dictIsChar) {
        ...
        return Control_Bind.bind(bindLex)(hexEscapeRegex)(function (esc) {
            ...
            if (v instanceof Data_Maybe.Nothing) {
                return Data_Function.apply(fail)(new PureScript_CST_Errors.LexCharEscapeOutOfRange(esc));
            };
    ...
    })(Data_Function.apply($$try)(Control_Apply.applySecond(applyLex)(charQuestionMark)(Control_Alt.alt(altLex)(parseIdent)(parseProper))));
        ...
        return Control_Bind.bind(bindLex)(parseNumberFractionPart)(function (fractionPart) {
            return Control_Bind.bind(bindLex)(parseNumberExponentPart)(function (exponentPart) {
                ...
                if ($249) {
                    ...
                    if (v instanceof Data_Maybe.Just) {
                        return Data_Function.apply(pure)(new PureScript_CST_Types.TokInt(intPart, new PureScript_CST_Types.SmallInt(v.value0)));
                    };
                    if (v instanceof Data_Maybe.Nothing) {
                        return Data_Function.apply(pure)(new PureScript_CST_Types.TokInt(intPart, new PureScript_CST_Types.BigInt(intVal)));
                    };
                ...
                if (v instanceof Data_Maybe.Just) {
                    return Data_Function.apply(pure)(new PureScript_CST_Types.TokNumber(raw, v.value0));
                };
                if (v instanceof Data_Maybe.Nothing) {
                    return Data_Function.apply(fail)(new PureScript_CST_Errors.LexNumberOutOfRange(raw));
                };
    ...
    var parseEscape = function (dictIsChar) {
        ...
        return Control_Bind.bind(bindLex)(charAny)(function (ch) {
            ...
            return Data_Function.apply(fail)(Data_Function.apply(PureScript_CST_Errors.LexInvalidCharEscape.create)(Data_String_CodeUnits.singleton(ch)));
        });
    };
    ...
    var parseChar = Control_Bind.bind(bindLex)(charAny)(function (ch) {
        ...
        if (ch === "'") {
            return Data_Function.apply(fail)(new PureScript_CST_Errors.LexExpected("character", "empty character literal"));
        };
        return Control_Applicative.pure(applicativeLex)({
    ...
    var go = function (stack) {
        return function (startPos) {
            return function (leading) {
                return function (str) {
                    return Data_Function.apply(PureScript_CST_TokenStream.TokenStream)(Data_Lazy.defer(function (v) {
                        var $270 = str === "";
                        if ($270) {
                            return Data_Function.apply(PureScript_CST_TokenStream.step)(PureScript_CST_TokenStream.unwindLayout(startPos)(Data_Function.apply(PureScript_CST_TokenStream.TokenStream)(Data_Lazy.defer(function (v1) {
                        ...
                        if (v1 instanceof LexSucc) {
                            ...
                            return Data_Function.apply(PureScript_CST_TokenStream.step)(Data_Function.apply(Data_Tuple.snd)(Data_Function.apply(PureScript_CST_TokenStream.consTokens(Data_Foldable.foldableArray)(v2.value1))(Data_Function.apply(Data_Tuple.Tuple.create(nextStart))(go(v2.value0)(nextStart)(v1.value0.nextLeading)(v1.value1)))));
                        };
            ...
            return function (str) {
                return Data_Function.apply(PureScript_CST_TokenStream.TokenStream)(Data_Lazy.defer(function (v) {
                    ...
                    if (v1 instanceof LexSucc) {
                        ...
                        return Data_Function.apply(PureScript_CST_TokenStream.step)(go(initStack)(nextPos)(v1.value0)(v1.value1));
                    };
