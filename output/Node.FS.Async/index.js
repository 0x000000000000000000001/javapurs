...
var lstat = function (file) {
    return function (cb) {
        return function () {
            return $foreign.lstatImpl(file, Data_Function.apply(handleCallback)(cb));
        };
    };
};
...
var stat = function (file) {
    return function (cb) {
        return function () {
            return $foreign.statImpl(file, Data_Function.apply(handleCallback)(cb));
        };
    };
};
...
var access$prime = function (path) {
    return function (mode) {
        return function (cb) {
            return Data_Function.apply(Effect_Uncurried.runEffectFn3($foreign.accessImpl)(path)(mode))(function (err) {
