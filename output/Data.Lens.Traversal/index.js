...
var failover = function (dictAlternative) {
    ...
    return function (t) {
        return function (f) {
            return function (s) {
                var v = Data_Newtype.unwrap()(Data_Function.apply(t)(Data_Function.apply(Data_Profunctor_Star.Star)((function () {
    ...
    return function (tr) {
        return function (pr) {
            return Data_Lens_Indexed.iwander(function (dictApplicative) {
                ...
                return function (f) {
                    return Data_Function.apply(unwrap)(Data_Function.apply(tr1)(Data_Function.apply(Data_Lens_Internal_Indexed.Indexed)(Data_Function.apply(Data_Profunctor_Star.Star)(function (v) {
                        var $40 = pr(v.value0);
                        if ($40) {
...
var element = function (dictWander) {
    ...
    return function (n) {
        return function (tr) {
            return Data_Function.apply(unIndex)(elementsOf(dictWander)(function (dictWander1) {
