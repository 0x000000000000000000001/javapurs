...
var unwindLayout = function (pos) {
    return function (eof) {
        var go = function (stk) {
            return Data_Function.apply(TokenStream)(Data_Lazy.defer(function (v) {
...
var consTokens = function (dictFoldable) {
    var go = function (v) {
        return function (v1) {
            return Data_Function.apply(Data_Tuple.Tuple.create(v.value0.range.start))(Data_Function.apply(TokenStream)(Data_Lazy.defer(function (v2) {
