...
var parsePartialModule = function (src) {
    return Data_Function.apply(toRecoveredParserResult)((function () {
        ...
        if (v instanceof PureScript_CST_Parser_Monad.ParseSucc) {
            var res = {
                ...
                full: Data_Lazy.defer(function (v1) {
                    return Data_Function.apply(toRecoveredParserResult)(Data_Function.apply(PureScript_CST_Parser_Monad.fromParserResult)(PureScript_CST_Parser_Monad["runParser$prime"](v.value1)(Control_Bind.bind(PureScript_CST_Parser_Monad.bindParser)(PureScript_CST_Parser.parseModuleBody)(function (body) {
            ...
            return Data_Function.apply(Data_Either.Right.create)(new Data_Tuple.Tuple(res, v.value1.errors));
        };
