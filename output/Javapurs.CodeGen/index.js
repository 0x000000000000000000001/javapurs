...
var wrapInBlock = function (res) {
    var $42 = Data_Array.length(res.stmts) === 0;
    if ($42) {
        return res.expr;
    };
    ...
    return function (op) {
        return function (e1) {
            return function (e2) {
                ...
                throw new Error("Failed pattern match at Javapurs.CodeGen (line 442, column 33 - line 490, column 111): " + [ op.constructor.name ]);
            };
        };
    };
};
        ...
        return function (e) {
            ...
            if (op instanceof PureScript_Backend_Optimizer_Syntax.OpIsTag) {
                ...
                var modPart = (function () {
                    ...
                    throw new Error("Failed pattern match at Javapurs.CodeGen (line 434, column 17 - line 436, column 27): " + [ op.value0.value0.constructor.name ]);
                })();
                var javaClass = modPart + ("." + safeTag);
                return new Javapurs_JavaAst.JavaInstanceOf(e, javaClass);
            };
            throw new Error("Failed pattern match at Javapurs.CodeGen (line 425, column 35 - line 439, column 33): " + [ op.constructor.name ]);
        };
    };
};
var syntaxTag = function (v) {
    ...
    throw new Error("Failed pattern match at Javapurs.CodeGen (line 268, column 13 - line 292, column 23): " + [ v.constructor.name ]);
};
...
var stripEffectAbs = function (v) {
    ...
    if (unwrapped instanceof PureScript_Backend_Optimizer_Syntax.Abs) {
        var $164 = Data_Array.length(Data_Array.fromFoldable(Data_Array_NonEmpty_Internal.foldableNonEmptyArray)(unwrapped.value0)) === 1;
        if ($164) {
            var v1 = Data_Array.head(Data_Array.fromFoldable(Data_Array_NonEmpty_Internal.foldableNonEmptyArray)(unwrapped.value0));
            ...
            if (v1 instanceof Data_Maybe.Just && v1.value0.value0 instanceof Data_Maybe.Just) {
                ...
                var $169 = v1.value0.value0.value0 === "$__unused";
                if ($169) {
                    return stripEffectAbs(unwrapped.value1);
                };
                return v;
...
var extractUncurriedAbs = function (v) {
    if (v.value1 instanceof PureScript_Backend_Optimizer_Syntax.Abs) {
        ...
        throw new Error("Failed pattern match at Javapurs.CodeGen (line 339, column 8 - line 341, column 47): " + [ v1.constructor.name ]);
    };
            ...
            return function (isTail) {
                return function (v) {
                    ...
                    if (v.value1 instanceof PureScript_Backend_Optimizer_Syntax.App) {
                        ...
                        if (isTail) {
                            ...
                            if (targetCtx instanceof Data_Maybe.Just) {
                                var $264 = Data_Array.length(flat.args) === Data_Array.length(targetCtx.value0.params);
                                if ($264) {
                            ...
                            throw new Error("Failed pattern match at Javapurs.CodeGen (line 69, column 12 - line 75, column 68): " + [ targetCtx.constructor.name ]);
                        };
                        return pureExpr(Data_Foldable.foldl(Data_Foldable.foldableArray)(Javapurs_JavaAst.JavaApply.create)(resFnExpr)(argsExprs));
                    };
                    if (v.value1 instanceof PureScript_Backend_Optimizer_Syntax.UncurriedApp) {
                        ...
                        if (isTail) {
                            ...
                            if (targetCtx instanceof Data_Maybe.Just) {
                                var $274 = Data_Array.length(flat.args) === Data_Array.length(targetCtx.value0.params);
                                if ($274) {
                                    return pureExpr(new Javapurs_JavaAst.JavaContinue(targetCtx.value0.ident, argsExprs));
                                };
                                return pureExpr(Data_Foldable.foldl(Data_Foldable.foldableArray)(Javapurs_JavaAst.JavaApply.create)(resFnExpr)(argsExprs));
                            ...
                            throw new Error("Failed pattern match at Javapurs.CodeGen (line 89, column 12 - line 95, column 68): " + [ targetCtx.constructor.name ]);
                        };
                        return pureExpr(Data_Foldable.foldl(Data_Foldable.foldableArray)(Javapurs_JavaAst.JavaApply.create)(resFnExpr)(argsExprs));
                    };
                    ...
                    if (v.value1 instanceof PureScript_Backend_Optimizer_Syntax.UncurriedAbs) {
                        ...
                        var $283 = inEffectBlock && Data_Array.length(v.value1.value0) === 0;
                        if ($283) {
                            return resBody;
                        };
                    ...
                    if (v.value1 instanceof PureScript_Backend_Optimizer_Syntax.UncurriedEffectAbs) {
                        ...
                        var $289 = inEffectBlock && Data_Array.length(v.value1.value0) === 0;
                        if ($289) {
                            return resBody;
                        };
                        return pureExpr(new Javapurs_JavaAst.JavaAbs(argsArray, wrapInBlock(resBody)));
                    ...
                    if (v.value1 instanceof PureScript_Backend_Optimizer_Syntax.LetRec) {
                        ...
                        var $309 = tcoInfo.role.isLoop && Data_Array.length(Data_Array.fromFoldable(Data_Array_NonEmpty_Internal.foldableNonEmptyArray)(v.value1.value1)) === 1;
                        if ($309) {
                            ...
                            if (v1 instanceof Data_Maybe.Just) {
                                ...
                                throw new Error("Failed pattern match at Javapurs.CodeGen (line 149, column 16 - line 162, column 98): " + [ v2.constructor.name ]);
                            };
                            if (v1 instanceof Data_Maybe.Nothing) {
                                return pureExpr(new Javapurs_JavaAst.JavaRaw("null"));
                            };
                            throw new Error("Failed pattern match at Javapurs.CodeGen (line 145, column 9 - line 163, column 47): " + [ v1.constructor.name ]);
                        };
                        var resBody = translateExprWith(inEffectBlock)(modName)(loopCtx)(isTail)(v.value1.value2);
                    ...
                    if (v.value1 instanceof PureScript_Backend_Optimizer_Syntax.CtorSaturated) {
                        ...
                        var modPart = (function () {
                            ...
                            throw new Error("Failed pattern match at Javapurs.CodeGen (line 191, column 17 - line 193, column 27): " + [ v.value1.value0.value0.constructor.name ]);
                        })();
                    ...
                    if (v.value1 instanceof PureScript_Backend_Optimizer_Syntax.Accessor) {
                        ...
                        if (v.value1.value1 instanceof PureScript_Backend_Optimizer_Syntax.GetCtorField) {
                            ...
                            var modPart = (function () {
                                ...
                                throw new Error("Failed pattern match at Javapurs.CodeGen (line 216, column 19 - line 218, column 29): " + [ v.value1.value1.value0.value0.constructor.name ]);
                            })();
                            var javaClass = modPart + ("." + safeCtorName);
                    ...
                    if (v.value1 instanceof PureScript_Backend_Optimizer_Syntax.Var) {
                        var qModName = (function () {
                            ...
                            throw new Error("Failed pattern match at Javapurs.CodeGen (line 230, column 20 - line 232, column 29): " + [ v.value1.value0.value0.constructor.name ]);
                        })();
                        ...
                        var buildTernary = function (v1) {
                            return function (v2) {
                                ...
                                if (v3 instanceof Data_Maybe.Just) {
                                    ...
                                    var $384 = Data_Array.length(v3.value0.head.cStmts) > 0 || Data_Array.length(v3.value0.head.vStmts) > 0;
                                    if ($384) {
                                ...
                                throw new Error("Failed pattern match at Javapurs.CodeGen (line 246, column 9 - line 253, column 23): " + [ v3.constructor.name ]);
                            };
                        };
                        return {
                            stmts: resDef.stmts,
                    ...
                    if (v.value1 instanceof PureScript_Backend_Optimizer_Syntax.PrimOp) {
                        ...
                        throw new Error("Failed pattern match at Javapurs.CodeGen (line 256, column 16 - line 263, column 69): " + [ v.value1.value0.constructor.name ]);
                    };
    ...
    var mainDecls = Data_Array.concatMap(function (group) {
        if (group.recursive) {
            return Data_Functor.map(Data_Functor.functorArray)(function (v1) {
                ...
                throw new Error("Failed pattern match at Javapurs.CodeGen (line 386, column 19 - line 397, column 71): " + [ v2.constructor.name ]);
            })(group.bindings);
        };
        return Data_Functor.map(Data_Functor.functorArray)(function (v1) {
            var res = translateExpr(modNameStr)([  ])(false)(v1.value1);
