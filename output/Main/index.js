...
var main = /* #__PURE__ */ Effect_Aff.launchAff_(/* #__PURE__ */ bind(/* #__PURE__ */ liftEffect(Node_Process.argv))(function (args) {
                                ...
                                return function (backendMod) {
                                    return function (v2) {
                                        ...
                                        return discard(liftEffect(Effect_Console.log("Building module " + modNameStr)))(function () {
                                            return bind(liftEffect(PureScript_Backend_Optimizer_FfiSupport.findFfiFile(".java")([  ])(Data_Maybe.Nothing.value)(modNameStr)(new Data_Maybe.Just(v1.path))))(function (ffiPathMb) {
                                                return bind((function () {
                                                    ...
                                                    var ffiStubs = (function () {
                                                        var $34 = Data_String_CodePoints.length(ffiContent) > 0;
                                                        if ($34) {
