...
var usingToImmutable = function (f) {
    return function (x) {
        return Data_Function.apply(unsafeThaw)(f(x));
    };
};
...
var toString$prime = function (enc) {
    return function (start) {
        return function (end) {
            return Data_Function.apply(usingFromImmutable)(Node_Buffer_Immutable["toString$prime"](enc)(start)(end));
        };
    };
};
var toString = function (enc) {
    return Data_Function.apply(usingFromImmutable)(Node_Buffer_Immutable.toString(enc));
};
...
var readString = function (enc) {
    return function (o) {
        return function (o$prime) {
            return Data_Function.apply(usingFromImmutable)(Node_Buffer_Immutable.readString(enc)(o)(o$prime));
        };
    };
};
var read = function (t) {
    return function (o) {
        return Data_Function.apply(usingFromImmutable)(Node_Buffer_Immutable.read(t)(o));
    };
};
var getAtOffset = function (o) {
    return Data_Function.apply(usingFromImmutable)(Node_Buffer_Immutable.getAtOffset(o));
};
var fromString = function (s) {
    return Data_Function.apply(usingToImmutable)(Node_Buffer_Immutable.fromString(s));
};
