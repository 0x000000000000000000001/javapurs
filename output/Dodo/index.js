...
var calcRibbonWidth = function (v) {
    return function (n) {
        return Data_Function.apply(Data_Ord.max(Data_Ord.ordInt)(0))(Data_Function.apply(Data_Int.ceil)(Data_Function.apply(Data_Semiring.mul(Data_Semiring.semiringNumber)(v.ribbonRatio))(Data_Function.apply(Data_Int.toNumber)(v.pageWidth - n | 0))));
    };
};
        ...
        var go = function (stack) {
            return function (state) {
                if (stack instanceof Data_List_Types.Nil) {
                    return Data_Function.apply(v.flushBuffer)(Dodo_Internal_Buffer.get(state.buffer));
                };
                if (stack instanceof Data_List_Types.Cons) {
                    if (stack.value0 instanceof Doc) {
                        if (stack.value0.value0 instanceof Dodo_Internal.Append) {
                            return go(new Data_List_Types.Cons(new Doc(stack.value0.value0.value0), new Data_List_Types.Cons(new Doc(stack.value0.value0.value1), stack.value1)))(state);
                        };
                        if (stack.value0.value0 instanceof Dodo_Internal.Text) {
                            ...
                            if (Data_Boolean.otherwise) {
                                if (state.flexGroup instanceof FlexGroupReset) {
                                    return Data_Function.apply(go(state.flexGroup.value0.stack))(resetState(state.flexGroup.value0));
                                };
                                return go(stack.value1)({
                                    annotations: state.annotations,
                                    indentSpaces: state.indentSpaces,
                        ...
                        if (stack.value0.value0 instanceof Dodo_Internal.Indent) {
                            if (state.position.column === 0) {
                                return go(new Data_List_Types.Cons(new Doc(stack.value0.value0.value0), new Data_List_Types.Cons(new Dedent(state.indentSpaces, state.position.nextIndent), stack.value1)))({
                                    buffer: state.buffer,
                                    annotations: state.annotations,
                                    flexGroup: state.flexGroup,
                                    options: state.options,
                        ...
                        if (stack.value0.value0 instanceof Dodo_Internal.Align) {
                            if (state.position.column === 0) {
                                return go(new Data_List_Types.Cons(new Doc(stack.value0.value0.value1), new Data_List_Types.Cons(new Dedent(state.indentSpaces, state.position.nextIndent), stack.value1)))({
                                    buffer: state.buffer,
                                    annotations: state.annotations,
                                    flexGroup: state.flexGroup,
                                    options: state.options,
                        ...
                        if (stack.value0.value0 instanceof Dodo_Internal.FlexSelect) {
                            if (state.flexGroup instanceof NoFlexGroup) {
                                return go(new Data_List_Types.Cons(new Doc(stack.value0.value0.value0), new Data_List_Types.Cons(new LeaveFlexGroup(stack.value0.value0.value1, stack.value0.value0.value2), stack.value1)))({
                            ...
                            if (state.flexGroup instanceof FlexGroupPending && state.position.ribbonWidth > 0) {
                                return go(new Data_List_Types.Cons(new Doc(stack.value0.value0.value0), new Data_List_Types.Cons(new Doc(stack.value0.value0.value1), stack.value1)))({
                                    position: state.position,
                                    annotations: state.annotations,
                                    indentSpaces: state.indentSpaces,
                                    options: state.options,
                                    flexGroup: Data_Function.apply(FlexGroupReset.create)(storeState(stack)(state)),
                        ...
                        if (stack.value0.value0 instanceof Dodo_Internal.FlexAlt) {
                            if (state.flexGroup instanceof FlexGroupReset) {
                                return go(new Data_List_Types.Cons(new Doc(stack.value0.value0.value0), stack.value1))(state);
                            };
                            if (state.flexGroup instanceof FlexGroupPending && state.position.ribbonWidth > 0) {
                                return go(new Data_List_Types.Cons(new Doc(stack.value0.value0.value0), stack.value1))({
                                    position: state.position,
                                    annotations: state.annotations,
                                    indentSpaces: state.indentSpaces,
                                    options: state.options,
                                    flexGroup: Data_Function.apply(FlexGroupReset.create)(storeState(new Data_List_Types.Cons(new Doc(stack.value0.value0.value1), stack.value1))(state)),
                                    buffer: Dodo_Internal_Buffer.branch(state.buffer)
                                });
                            };
                            return go(new Data_List_Types.Cons(new Doc(stack.value0.value0.value1), stack.value1))(state);
                        };
                        if (stack.value0.value0 instanceof Dodo_Internal.WithPosition) {
                            if (state.position.column === 0 && state.position.nextIndent > 0) {
                                return go(new Data_List_Types.Cons(new Doc(stack.value0.value0.value0({
                                    line: state.position.line,
                                    indent: state.position.indent,
                                    nextIndent: state.position.nextIndent,
                                    pageWidth: state.position.pageWidth,
                            ...
                            if (Data_Boolean.otherwise) {
                                return go(new Data_List_Types.Cons(new Doc(stack.value0.value0.value0(state.position)), stack.value1))(state);
                            };
                        };
                        if (stack.value0.value0 instanceof Dodo_Internal.Annotate) {
                            return go(new Data_List_Types.Cons(new Doc(stack.value0.value0.value1), new Data_List_Types.Cons(new LeaveAnnotation(stack.value0.value0.value0, state.annotations), stack.value1)))({
                                position: state.position,
                                indentSpaces: state.indentSpaces,
                                flexGroup: state.flexGroup,
                                options: state.options,
                        ...
                        if (stack.value0.value0 instanceof Dodo_Internal.Local) {
                            ...
                            return Data_Function.apply(go(new Data_List_Types.Cons(new Doc(v1.value1), new Data_List_Types.Cons(new LeaveLocal(prevOptions), stack.value1))))(storeOptions(state.position.indent)(v1.value0)(state));
                        };
                        if (stack.value0.value0 instanceof Dodo_Internal.Empty) {
                            return go(stack.value1)(state);
                        };
                    ...
                    if (stack.value0 instanceof LeaveFlexGroup) {
                        if (state.flexGroup instanceof NoFlexGroup) {
                            return go(new Data_List_Types.Cons(new Doc(stack.value0.value1), stack.value1))({
                                position: state.position,
                                annotations: state.annotations,
                                indentSpaces: state.indentSpaces,
                                flexGroup: state.flexGroup,
                        ...
                        return go(new Data_List_Types.Cons(new Doc(stack.value0.value0), stack.value1))({
                            position: state.position,
                            annotations: state.annotations,
                            indentSpaces: state.indentSpaces,
                            options: state.options,
                    ...
                    if (stack.value0 instanceof LeaveLocal) {
                        return Data_Function.apply(go(stack.value1))(storeOptions(state.position.indent)(stack.value0.value0)(state));
                    };
