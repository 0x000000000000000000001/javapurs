    ...
    ix: function (n) {
        return function (dictStrong) {
            return function (dictChoice) {
                var set = function (s) {
                    return function (b) {
                        return Data_Function.apply(Data_Maybe.fromMaybe(s))(Data_Array_NonEmpty.updateAt(n)(b)(s));
                    };
                };
                var pre = function (s) {
                    return Data_Function.apply(Data_Maybe.maybe(new Data_Either.Left(s))(Data_Either.Right.create))(Data_Array_NonEmpty.index(s)(n));
                };
                return Data_Lens_AffineTraversal.affineTraversal(set)(pre)(dictStrong)(dictChoice);
            };
        };
        ...
        ix: function (k) {
            return function (dictStrong) {
                return function (dictChoice) {
                    ...
                    var pre = function (s) {
                        return Data_Function.apply(Data_Maybe.maybe(new Data_Either.Left(s))(Data_Either.Right.create))(Data_Map_Internal.lookup(dictOrd)(k)(s));
                    };
                    return Data_Lens_AffineTraversal.affineTraversal(set)(pre)(dictStrong)(dictChoice);
                };
            };
    ...
    ix: function (n) {
        return function (dictStrong) {
            return function (dictChoice) {
                var set = function (s) {
                    return function (b) {
                        return Data_Function.apply(Data_Maybe.fromMaybe(s))(Data_List.updateAt(n)(b)(s));
                    };
                };
                var pre = function (s) {
                    return Data_Function.apply(Data_Maybe.maybe(new Data_Either.Left(s))(Data_Either.Right.create))(Data_List.index(s)(n));
                };
                return Data_Lens_AffineTraversal.affineTraversal(set)(pre)(dictStrong)(dictChoice);
            };
        };
    ...
    ix: function (k) {
        return function (dictStrong) {
            return function (dictChoice) {
                ...
                var pre = function (s) {
                    return Data_Function.apply(Data_Maybe.maybe(new Data_Either.Left(s))(Data_Either.Right.create))(Foreign_Object.lookup(k)(s));
                };
                return Data_Lens_AffineTraversal.affineTraversal(set)(pre)(dictStrong)(dictChoice);
            };
        };
    ...
    ix: function (n) {
        return function (dictStrong) {
            return function (dictChoice) {
                var set = function (s) {
                    return function (b) {
                        return Data_Function.apply(Data_Maybe.fromMaybe(s))(Data_Array.updateAt(n)(b)(s));
                    };
                };
                var pre = function (s) {
                    return Data_Function.apply(Data_Maybe.maybe(new Data_Either.Left(s))(Data_Either.Right.create))(Data_Array.index(s)(n));
                };
                return Data_Lens_AffineTraversal.affineTraversal(set)(pre)(dictStrong)(dictChoice);
            };
        };
