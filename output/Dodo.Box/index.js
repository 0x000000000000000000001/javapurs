...
var $lazy_functorDocBox = /* #__PURE__ */ $runtime_lazy("functorDocBox", "Dodo.Box", function () {
    return {
        map: function (f) {
            return function (m) {
                ...
                if (m instanceof DocVApp) {
                    return new DocVApp(Data_Functor.map($lazy_functorDocBox(0))(f)(m.value0), Data_Functor.map($lazy_functorDocBox(0))(f)(m.value1), m.value2);
                };
                if (m instanceof DocHApp) {
                    return new DocHApp(Data_Functor.map($lazy_functorDocBox(0))(f)(m.value0), Data_Functor.map($lazy_functorDocBox(0))(f)(m.value1), m.value2);
                };
                if (m instanceof DocAlign) {
                    return new DocAlign(m.value0, m.value1, Data_Functor.map($lazy_functorDocBox(0))(f)(m.value2));
                };
...
var functorDocBox = /* #__PURE__ */ $lazy_functorDocBox(72);
            ...
            function $tco_loop(cmd, stack) {
                if (cmd instanceof ResumeEnter) {
                    ...
                    if (cmd.value0 instanceof StpLine) {
                        $tco_var_cmd = Data_Function.apply(ResumeLeave.create)(new Data_Maybe.Just({
