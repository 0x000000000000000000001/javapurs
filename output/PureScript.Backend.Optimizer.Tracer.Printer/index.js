...
var printRecord = function (sep) {
    ...
    var $235 = foldWithSeparator(Dodo_Common.leadingComma);
    var $236 = map(printProp);
    return function ($237) {
        return Dodo_Common.pursCurlies($235($236($237)));
    };
};
...
var printLet = function (letKeyword) {
    return Data_Tuple.curry((function () {
        var $238 = printLet$prime(letKeyword);
        return function ($239) {
            return $238(pure($239));
        };
    })());
...
var printCurriedApp = function (fn) {
    return function (args) {
        return new Data_Tuple.Tuple(PrecApply.value, Dodo.flexGroup(foldWithSeparator1(Dodo.spaceBreak)(Data_Array_NonEmpty.cons(wrapPrec(PrecApply.value)(fn))(map1((function () {
            var $240 = wrapPrec(PrecAccess.value);
            return function ($241) {
                return Dodo.indent($240($241));
            };
        })())(args)))));
    };
};
...
var printArray = /* #__PURE__ */ (function () {
    var $242 = foldWithSeparator(Dodo_Common.leadingComma);
    return function ($243) {
        return Dodo_Common.pursSquares($242($243));
    };
})();
var printLiteral = /* #__PURE__ */ (function () {
    var $244 = Data_Tuple.Tuple.create(PrecAtom.value);
    return function ($245) {
...
var printBackendSyntax = function (v) {
    ...
    if (v instanceof PureScript_Backend_Optimizer_Syntax.LetRec) {
        return new Data_Tuple.Tuple(PrecBlock.value, lines([ printLet$prime("letrec")(Data_Array_NonEmpty.toArray(map1(function (v1) {
    ...
    if (v instanceof PureScript_Backend_Optimizer_Syntax.Let) {
        return new Data_Tuple.Tuple(PrecBlock.value, lines([ printLet("let")(printLocal(v.value0)(v.value1))(Data_Tuple.snd(v.value2)), Data_Tuple.snd(v.value3) ]));
    };
...
var printBackendExpr = /* #__PURE__ */ PureScript_Backend_Optimizer_Semantics.foldBackendExpr(printBackendSyntax)(function (rewrite) {
    return function (expr) {
        return new Data_Tuple.Tuple(Data_Tuple.fst(expr), lines([ printBackendRewriteCase(rewrite), Data_Tuple.snd(expr) ]));
    };
});
    ...
    return function (steps) {
        ...
        var renderStep = function (idx) {
            return function (step) {
                return lines([ heading((function () {
                    var $228 = idx === 0;
                    if ($228) {
                        return "+";
                    };
                    return "-";
                })())(words([ ident, Dodo.text("Step"), Dodo.text(show1(idx + 1 | 0)), (function () {
