...
var topoSort = function (dictOrd) {
    ...
    return function (graph) {
        ...
        var startingModules = Data_Function.apply(Data_Map.keys)(Data_Map_Internal.filterWithKey(dictOrd)(function (k) {
            return function (v) {
        ...
        var go = function ($copy_v) {
            ...
            function $tco_loop(v) {
                ...
                if (v1 instanceof Data_Maybe.Nothing) {
                    ...
                    var nonLeaf = Data_Function.applyFlipped(Data_Function.applyFlipped(v.usages)(Data_Map_Internal.filterWithKey(dictOrd)(function (a) {
...
var sortModules = function (k) {
    return function (moduleHeaders) {
        ...
        var knownModuleHeaders = Data_Function.applyFlipped(Data_Function.applyFlipped(moduleHeaders)(Data_Functor.map(Data_Functor.functorArray)(function (a) {
