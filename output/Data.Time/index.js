...
var adjust = function (dictDuration) {
    return function (d) {
        return function (t) {
            ...
            var wrap = (function () {
                var $118 = Data_Ord.greaterThan(Data_Time_Duration.ordMilliseconds)(msAdjusted)(maxTime);
                if ($118) {
                    return 1.0;
                };
                var $119 = Data_Ord.lessThan(Data_Time_Duration.ordMilliseconds)(msAdjusted)(minTime);
                if ($119) {
                    return -1.0;
                };
                return 0.0;
