...
var writeString$prime = function (w) {
    return function (enc) {
        return function (str) {
            return function (cb) {
                return Data_Function.apply(Effect_Uncurried.runEffectFn4($foreign.writeStringCbImpl)(w)(str)(Node_Encoding.encodingToNode(enc)))(function (err) {
...
var write$prime = function (w) {
    return function (b) {
        return function (cb) {
            return Data_Function.apply(Effect_Uncurried.runEffectFn3($foreign.writeCbImpl)(w)(b))(function (err) {
                return cb(Data_Nullable.toMaybe(err))();
            });
        };
    };
        ...
        return function __do() {
            ...
            if (v instanceof Data_Maybe.Just) {
                return $foreign.readChunkImpl(function (buf) {
                    return Data_Function.apply(pure1)(new Data_Maybe.Just(buf))();
                }, function (v1) {
...
var pipeline = function (src) {
    return function (transforms) {
        return function (dest) {
            return function (cb) {
                return Data_Function.apply(Effect_Uncurried.runEffectFn4($foreign.pipelineImpl)(src)(transforms)(dest))(function (err) {
                    return cb(Data_Nullable.toMaybe(err))();
                });
            };
        };
...
var end$prime = function (w) {
    return function (cb) {
        return Data_Function.apply(Effect_Uncurried.runEffectFn2($foreign.endCbImpl)(w))(function (err) {
            return cb(Data_Nullable.toMaybe(err))();
        });
    };
};
