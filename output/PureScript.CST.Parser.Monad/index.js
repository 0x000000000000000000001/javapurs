...
var runParser$prime = function (state1) {
    return function (v) {
        ...
        return Data_Function.apply(run)(v(state1, More.create, function (state2, error) {
        ...
        var $lazy_go = $runtime_lazy("go", "PureScript.CST.Parser.Monad", function () {
            return function (acc, state2) {
                ...
                return v(state2$prime, more, function (state3, error) {
                    ...
                    return done(state2, Data_Array.reverse(Data_List.toUnfoldable(Data_Unfoldable.unfoldableArray)(acc)));
