        ...
        return function (k) {
            var go = function (f) {
                ...
                if (v instanceof Return) {
                    return Data_Functor.map(Functor0)(Control_Monad_Rec_Class.Done.create)(Control_Applicative.pure(Applicative0)(v.value0));
                };
                if (v instanceof Bind) {
                    return Data_Functor.map(Functor0)(Control_Monad_Rec_Class.Loop.create)(k(Data_Functor.map(dictFunctor)(v.value1)(v.value0)));
                };
...
var $lazy_freeApplicative = /* #__PURE__ */ $runtime_lazy("freeApplicative", "Control.Monad.Free", function () {
    return {
        pure: function ($162) {
            return fromView(Return.create($162));
        },
        Apply0: function () {
...
var $lazy_freeApply = /* #__PURE__ */ $runtime_lazy("freeApply", "Control.Monad.Free", function () {
    return {
        apply: Control_Monad.ap($lazy_freeMonad(0)),
        Functor0: function () {
            return $lazy_freeFunctor(0);
        }
    };
});
var $lazy_freeBind = /* #__PURE__ */ $runtime_lazy("freeBind", "Control.Monad.Free", function () {
    return {
        bind: function (v) {
            return function (k) {
...
var $lazy_freeFunctor = /* #__PURE__ */ $runtime_lazy("freeFunctor", "Control.Monad.Free", function () {
    return {
        map: function (k) {
            return function (f) {
                return Control_Bind.bindFlipped($lazy_freeBind(0))((function () {
                    var $163 = Control_Applicative.pure($lazy_freeApplicative(0));
                    return function ($164) {
                        return $163(k($164));
                    };
                })())(f);
...
var $lazy_freeMonad = /* #__PURE__ */ $runtime_lazy("freeMonad", "Control.Monad.Free", function () {
    return {
        Applicative0: function () {
            return $lazy_freeApplicative(0);
        },
        Bind1: function () {
            return $lazy_freeBind(0);
        }
    };
});
var freeApplicative = /* #__PURE__ */ $lazy_freeApplicative(74);
var freeApply = /* #__PURE__ */ $lazy_freeApply(77);
var freeBind = /* #__PURE__ */ $lazy_freeBind(68);
var freeFunctor = /* #__PURE__ */ $lazy_freeFunctor(65);
var freeMonad = /* #__PURE__ */ $lazy_freeMonad(80);
...
var $lazy_freeMonadRec = /* #__PURE__ */ $runtime_lazy("freeMonadRec", "Control.Monad.Free", function () {
    return {
        tailRecM: function (k) {
            return function (a) {
                return Control_Bind.bind(freeBind)(k(a))(function (v) {
                    if (v instanceof Control_Monad_Rec_Class.Loop) {
                        return Control_Monad_Rec_Class.tailRecM($lazy_freeMonadRec(0))(k)(v.value0);
                    };
...
var freeMonadRec = /* #__PURE__ */ $lazy_freeMonadRec(85);
var liftF = function (f) {
    return fromView(new Bind(f, function ($165) {
        return pure($165);
    }));
};
var freeMonadTrans = {
...
var foldableFree = function (dictFunctor) {
    ...
    var resume3 = resume(dictFunctor);
...
var traversableFree = function (dictTraversable) {
    ...
    return {
        traverse: function (dictApplicative) {
            var Functor01 = (dictApplicative.Apply0()).Functor0();
            return function (f) {
                var $lazy_go = $runtime_lazy("go", "Control.Monad.Free", function () {
                    return function ($170) {
                        return (function (v) {
                            if (v instanceof Data_Either.Left) {
                                return Data_Functor.map(Functor01)(function ($171) {
                                    return join(liftF($171));
                                })(Data_Traversable.traverse(dictTraversable)(dictApplicative)($lazy_go(111))(v.value0));
                            };
                            if (v instanceof Data_Either.Right) {
                                return Data_Functor.map(Functor01)(pure1)(f(v.value0));
                            };
...
var foldFree = function (dictMonadRec) {
    ...
    return function (k) {
        var go = function (f) {
            ...
            if (v instanceof Bind) {
                return Data_Functor.map(Functor0)(function ($172) {
                    return Control_Monad_Rec_Class.Loop.create(v.value1($172));
                })(k(v.value0));
            };
