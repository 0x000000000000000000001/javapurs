...
var ansiGraphics = /* #__PURE__ */ (function () {
    ...
    var resetCode = Data_Function.apply(Ansi_Codes.escapeCodeToString)(Data_Function.apply(Ansi_Codes.Graphics.create)(Control_Applicative.pure(Data_List_Types.applicativeNonEmptyList)(Ansi_Codes.Reset.value)));
    ...
    var leaveAnnotation = function (v) {
        return function (as) {
            return function (v1) {
                ...
                return {
                    output: v1.output,
                    pending: Data_Function.apply(Data_Maybe.Just.create)(Data_Function.apply(Data_Maybe.fromMaybe(Control_Applicative.pure(Data_List_Types.applicativeNonEmptyList)(Ansi_Codes.Reset.value)))(getPendingGraphics(current))),
                    current: current,
                    previous: v1.current
                };
            };
