...
var $lazy_foldableCatQueue = /* #__PURE__ */ $runtime_lazy("foldableCatQueue", "Data.CatQueue", function () {
    return {
        foldMap: function (dictMonoid) {
            return Data_Foldable.foldMapDefaultL($lazy_foldableCatQueue(0))(dictMonoid);
        },
        foldr: function (f) {
            return Data_Foldable.foldrDefault($lazy_foldableCatQueue(0))(f);
        },
        foldl: function (f) {
...
var foldableCatQueue = /* #__PURE__ */ $lazy_foldableCatQueue(142);
...
var $lazy_traversableCatQueue = /* #__PURE__ */ $runtime_lazy("traversableCatQueue", "Data.CatQueue", function () {
    return {
        ...
        sequence: function (dictApplicative) {
            return Data_Traversable.sequenceDefault($lazy_traversableCatQueue(0))(dictApplicative);
        },
        Functor0: function () {
...
var traversableCatQueue = /* #__PURE__ */ $lazy_traversableCatQueue(165);
...
var $lazy_applicativeCatQueue = /* #__PURE__ */ $runtime_lazy("applicativeCatQueue", "Data.CatQueue", function () {
    return {
        pure: singleton,
        Apply0: function () {
...
var $lazy_applyCatQueue = /* #__PURE__ */ $runtime_lazy("applyCatQueue", "Data.CatQueue", function () {
    return {
        apply: Control_Monad.ap($lazy_monadCatQueue(0)),
        Functor0: function () {
            return functorCatQueue;
        }
    };
});
var $lazy_bindCatQueue = /* #__PURE__ */ $runtime_lazy("bindCatQueue", "Data.CatQueue", function () {
    return {
...
var $lazy_monadCatQueue = /* #__PURE__ */ $runtime_lazy("monadCatQueue", "Data.CatQueue", function () {
    return {
        Applicative0: function () {
            return $lazy_applicativeCatQueue(0);
        },
        Bind1: function () {
            return $lazy_bindCatQueue(0);
        }
    };
});
var applicativeCatQueue = /* #__PURE__ */ $lazy_applicativeCatQueue(177);
var applyCatQueue = /* #__PURE__ */ $lazy_applyCatQueue(174);
var bindCatQueue = /* #__PURE__ */ $lazy_bindCatQueue(180);
var monadCatQueue = /* #__PURE__ */ $lazy_monadCatQueue(183);
var altCatQueue = {
