...
const expressions = { swap, ordered, captures, nested, branches, letRec, nestedLetRec, argumentFailure, fallback };
const printed = Object.fromEntries(Object.entries(expressions).map(([name, expr]) => [name, printExpr(expr)]));
for (const name of ["swap", "ordered", "captures", "nested", "branches", "letRec", "nestedLetRec", "argumentFailure"]) {
...
public class TcoPrinterRegression {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("TCO printer: 9 behavioral cases passed");
    }
}
