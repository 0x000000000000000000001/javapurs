...
var topLevelTcoRefBindings = function (mod) {
    return tcoRefBindings((function () {
        var $321 = PureScript_Backend_Optimizer_CoreFn.Qualified.create(new Data_Maybe.Just(mod));
        return function ($322) {
            return TcoTopLevel.create($321($322));
        };
    })());
};
...
var tcoEnvGroup = function (toTcoRef) {
    ...
    var $323 = traverse1(go);
    return function ($324) {
        return fold($323(Data_Array_NonEmpty.toArray($324)));
    };
};
var topLevelTcoEnvGroup = function (mod) {
    return tcoEnvGroup((function () {
        var $325 = PureScript_Backend_Optimizer_CoreFn.Qualified.create(new Data_Maybe.Just(mod));
        return function ($326) {
            return TcoTopLevel.create($325($326));
        };
    })());
};
    ...
    var go = function ($copy_stack) {
        return function ($copy_v) {
            ...
            function $tco_loop(stack, v) {
                ...
                if (v instanceof Data_List_Types.Cons) {
                    var $243 = Data_Array_NonEmpty.findIndex(eq4(ref))(v.value0.value1);
                    if ($243 instanceof Data_Maybe.Just) {
                        $tco_done = true;
                        return new Data_Maybe.Just({
    ...
    append: function (v) {
        return function (v1) {
            return {
                ...
                tailCalls: unionWith(add)(v.tailCalls)(v1.tailCalls),
                role: noTcoRole
            };
        };
    }
...
var tcoRoleIsLoop = function (group) {
    return Data_Array_NonEmpty.all((function () {
        var $327 = Data_Function.flip(isTailCalledIn)(group);
        return function ($328) {
...
var analyze = function (env) {
    return function (v) {
        ...
        var v1 = function (v2) {
            var v3 = function (v4) {
                        ...
                        if (v instanceof PureScript_Backend_Optimizer_Syntax.Let) {
                            ...
                            var role = {
                                ...
                                joins: foldMap3((function () {
                                    var $329 = tcoRoleJoins(env)(tcoAnalysisOf(body$prime));
                                    return function ($330) {
                                        return $329(pure($330));
                                    };
                                })())(refBinding)
                ...
                if (v instanceof PureScript_Backend_Optimizer_Syntax.PrimEffect && v.value0 instanceof PureScript_Backend_Optimizer_Syntax.EffectRefRead) {
                    var $303 = unwrapRefHead(v.value0.value0);
                    if ($303 instanceof Data_Maybe.Just) {
                        var ref$prime = analyze(env)(v.value0.value0);
                        var analysis = tcoRefEffect($303.value0)(mempty);
            ...
            if (v instanceof PureScript_Backend_Optimizer_Syntax.UncurriedApp) {
                var $308 = unwrapAppHead(v.value0)(Data_Array.length(v.value1));
                if ($308 instanceof Data_Maybe.Just) {
                    var hd$prime = analyze(env)(v.value0);
                    var tl$prime = map4((function () {
                        var $331 = overTcoAnalysis(tcoNoTailCalls);
                        var $332 = analyze(env);
                        return function ($333) {
                            return $331($332($333));
                        };
                    })())(v.value1);
                    var analysis2 = tcoCall($308.value0.value0)($308.value0.value1)(foldMap9(tcoAnalysisOf)(tl$prime));
        ...
        if (v instanceof PureScript_Backend_Optimizer_Syntax.App) {
            var $315 = unwrapAppHead(v.value0)(Data_Array_NonEmpty.length(v.value1));
            if ($315 instanceof Data_Maybe.Just) {
                var hd$prime = analyze(env)(v.value0);
                var tl$prime = map1((function () {
                    var $334 = overTcoAnalysis(tcoNoTailCalls);
                    var $335 = analyze(env);
                    return function ($336) {
                        return $334($335($336));
                    };
                })())(v.value1);
                var analysis2 = tcoCall($315.value0.value0)($315.value0.value1)(foldMap4(tcoAnalysisOf)(tl$prime));
