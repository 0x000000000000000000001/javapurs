    ...
    return function (s) {
        return function (v) {
            ...
            if (v instanceof Javapurs_JavaAst.JavaLocal) {
                var $97 = Data_String_CodePoints.take(8)(v.value0) === "__final_";
                if ($97) {
            ...
            if (v instanceof Javapurs_JavaAst.JavaAbs) {
                ...
                var args$prime = map(function (n) {
                    return n + ("_i" + show(s));
                })(v.value0);
                var env$prime = foldl(function (acc) {
                    return function (v1) {
            ...
            if (v instanceof Javapurs_JavaAst.JavaLet) {
                var v1 = rename(env)(s)(v.value1);
                var newN = v.value0 + ("_i" + show(v1.value1));
            ...
            if (v instanceof Javapurs_JavaAst.JavaLetRec) {
                var names = map(function (v1) {
                    return v1.value0;
                })(v.value0);
                var newNames = Data_Array.mapWithIndex(function (i) {
                    return function (n) {
                        return n + ("_i" + show(s + i | 0));
                    };
                })(names);
