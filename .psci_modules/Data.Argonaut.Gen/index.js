            ...
            var extendJObj = function (obj) {
                return function (k) {
                    return bind(genJson(dictMonadGen)(dictMonadRec)(dictLazy))(function (v) {
                        return pure1(Data_Argonaut_Core.caseJsonObject(Data_Argonaut_Core.jsonSingletonObject(k)(v))((function () {
                            var $36 = Foreign_Object.insert(k)(v);
                            return function ($37) {
                                return Data_Argonaut_Core.fromObject($36($37));
                            };
                        })())(obj));
                    });
                };
